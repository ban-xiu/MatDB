(function(a, m) {
    ...
    function l(g) {
        var w = g.length
          , a = f.type(g);
        return "function" === a || f.isWindow(g) ? !1 : 1 === g.nodeType && w ? !0 : "array" === a || 0 === w || "number" === typeof w && 0 < w && w - 1 in g
    }
    function h(g, a, p) {
        if (f.isFunction(a))
    ...
    function j() {
        y.addEventListener ? (y.removeEventListener("DOMContentLoaded", t, !1),
        a.removeEventListener("load", t, !1)) : (y.detachEvent("onreadystatechange", t),
        a.detachEvent("onload", t))
    }
    function t() {
        if (y.addEventListener || "load" === event.type || "complete" === y.readyState)
            j(),
            f.ready()
    }
    function s(g, a, p) {
        if (void 0 === p && 1 === g.nodeType)
            if (p = "data-" + a.replace(Wc, "-$1").toLowerCase(),
            p = g.getAttribute(p),
            "string" === typeof p) {
                try {
                    p = "true" === p ? !0 : "false" === p ? !1 : "null" === p ? null : +p + "" === p ? +p : Xc.test(p) ? f.parseJSON(p) : p
                } catch (Xa) {}
                f.data(g, a, p)
            } else
                p = void 0;
    ...
    function u(g) {
        for (var a in g)
            if (!("data" === a && f.isEmptyObject(g[a])) && "toJSON" !== a)
                return !1;
        return !0
    }
    function b(g, a, p, Xa) {
        if (f.acceptData(g)) {
            var b = f.expando
              ...
              , d = c ? f.cache : g
              , n = c ? g[b] : g[b] && b;
            if (n && d[n] && (Xa || d[n].data) || !(void 0 === p && "string" === typeof a)) {
                n || (n = c ? g[b] = k.pop() || f.guid++ : b);
                d[n] || (d[n] = c ? {} : {
                    toJSON: f.noop
                });
                if ("object" === typeof a || "function" === typeof a)
                    Xa ? d[n] = f.extend(d[n], a) : d[n].data = f.extend(d[n].data, a);
                g = d[n];
                Xa || (g.data || (g.data = {}),
                g = g.data);
                void 0 !== p && (g[f.camelCase(a)] = p);
                "string" === typeof a ? (p = g[a],
                null == p && (p = g[f.camelCase(a)])) : p = g;
                return p
            }
        }
    }
        ...
        if (f.acceptData(g)) {
            ...
            if (d[n]) {
                if (a && (b = p ? d[n] : d[n].data)) {
                    f.isArray(a) ? a = a.concat(f.map(a, f.camelCase)) : a in b ? a = [a] : (a = f.camelCase(a),
                    a = a in b ? [a] : a.split(" "));
                    for (c = a.length; c--; )
                        delete b[a[c]];
                    if (p ? !u(b) : !f.isEmptyObject(b))
                        return
                }
                if (!p && (delete d[n].data,
                !u(d[n])))
                    return;
                k ? f.cleanData([g], !0) : v.deleteExpando || d != d.window ? delete d[n] : d[n] = null
            }
        }
    }
    function d() {
    ...
    function C(g, a) {
        var p, b, c = 0, k = typeof g.getElementsByTagName !== ka ? g.getElementsByTagName(a || "*") : typeof g.querySelectorAll !== ka ? g.querySelectorAll(a || "*") : void 0;
        if (!k) {
            k = [];
    ...
    function Ya(g, a) {
        return f.nodeName(g, "table") && f.nodeName(11 !== a.nodeType ? a : a.firstChild, "tr") ? g.getElementsByTagName("tbody")[0] || g.appendChild(g.ownerDocument.createElement("tbody")) : g
    }
    function Ca(g) {
    ...
    function Da(g, a) {
        if (1 === a.nodeType && f.hasData(g)) {
            ...
            var k = f._data(a, b)
              , d = b.events;
            if (d)
                for (p in delete k.handle,
                k.events = {},
                d) {
                    b = 0;
                    for (c = d[p].length; b < c; b++)
                        f.event.add(a, p, d[p][b])
                }
    ...
    function db(g) {
        ...
        if (!p) {
            p = Na(g, a);
            if ("none" === p || !p)
                eb = (eb || f("<iframe frameborder='0' width='0' height='0'/>")).appendTo(a.documentElement),
    ...
    function ta(g, a) {
        for (var p, b, c, k = [], d = 0, n = g.length; d < n; d++)
            if (b = g[d],
            b.style)
                if (k[d] = f._data(b, "olddisplay"),
                p = b.style.display,
                a)
                    !k[d] && "none" === p && (b.style.display = ""),
                    "" === b.style.display && hb(b) && (k[d] = f._data(b, "olddisplay", db(b.nodeName)));
                else if (!k[d] && (c = hb(b),
                p && "none" !== p || !c))
    ...
    function x(g, a, p, b, c) {
        ...
        for (var k = 0; 4 > a; a += 2)
            ...
            b ? ("content" === p && (k -= f.css(g, "padding" + Oa[a], !0, c)),
            "margin" !== p && (k -= f.css(g, "border" + Oa[a] + "Width", !0, c))) : (k += f.css(g, "padding" + Oa[a], !0, c),
            "padding" !== p && (k += f.css(g, "border" + Oa[a] + "Width", !0, c)));
        return k
    }
    function W(g, a, p) {
        var b = !0
    ...
    function jb(g, a, p) {
        var b, c, k = 0, d = tb.length, n = f.Deferred().always(function() {
            delete e.elem
        }), e = function() {
            if (c)
                return !1;
            for (var a = Za || ga(), a = Math.max(0, r.startTime + r.duration - a), w = 1 - (a / r.duration || 0), p = 0, b = r.tweens.length; p < b; p++)
                r.tweens[p].run(w);
            ...
            createTween: function(a, w) {
                var p = f.Tween(g, r.opts, a, w, r.opts.specialEasing[a] || r.opts.easing);
                r.tweens.push(p);
                return p
            },
            stop: function(a) {
    ...
    function kb(g) {
        return function(a, p) {
            "string" !== typeof a && (p = a,
            a = "*");
            var b, c = 0, k = a.toLowerCase().match(va) || [];
            if (f.isFunction(p))
                for (; b = k[c++]; )
                    "+" === b.charAt(0) ? (b = b.slice(1) || "*",
                    (g[b] = g[b] || []).unshift(p)) : (g[b] = g[b] || []).push(p)
        }
    }
    function ub(g, a, p, b) {
        function c(n) {
    ...
    function ma(g, a, p, b) {
        ...
        if (f.isArray(a))
            f.each(a, function(a, w) {
                p || ad.test(g) ? b(g, w) : ma(g + "[" + ("object" === typeof w ? a : "") + "]", w, p, b)
            });
    ...
    function B(g) {
        try {
            return g ? new a.ActiveXObject("Microsoft.XMLHTTP") : new a.XMLHttpRequest
        } catch (w) {}
    }
    function X() {
        try {
    ...
    f.extend = f.fn.extend = function() {
        var g, a, p, b, c, k = arguments[0] || {}, d = 1, n = arguments.length, e = !1;
        "boolean" === typeof k && (e = k,
        k = arguments[d] || {},
        d++);
        ...
        for (; d < n; d++)
            if (null != (c = arguments[d]))
                for (b in c)
                    g = k[b],
                    p = c[b],
                    k !== p && (e && p && (f.isPlainObject(p) || (a = f.isArray(p))) ? (a ? (a = !1,
                    g = g && f.isArray(g) ? g : []) : g = g && f.isPlainObject(g) ? g : {},
                    k[b] = f.extend(e, g, p)) : void 0 !== p && (k[b] = p));
        return k
    }
    ;
    f.extend({
        ...
        isPlainObject: function(g) {
            ...
            if (!g || "object" !== f.type(g) || g.nodeType || f.isWindow(g))
                return !1;
            try {
                if (g.constructor && !xa.call(g, "constructor") && !xa.call(g.constructor.prototype, "isPrototypeOf"))
                    return !1
            } catch (p) {
                return !1
            }
        ...
        type: function(g) {
            return null == g ? g + "" : "object" === typeof g || "function" === typeof g ? N[bd.call(g)] || "object" : typeof g
        },
        ...
        each: function(g, a, p) {
            var b, f = 0, c = g.length;
            b = l(g);
            if (p)
                if (b)
                    for (; f < c && !(b = a.apply(g[f], p),
                    !1 === b); f++)
                        ;
                else
                    for (f in g) {
                ...
                for (; f < c && !(b = a.call(g[f], f, g[f]),
                !1 === b); f++)
                    ;
            else
                for (f in g)
                    if (b = a.call(g[f], f, g[f]),
                    !1 === b)
                        break;
            return g
        },
        ...
        merge: function(g, a) {
            for (var p = +a.length, b = 0, f = g.length; b < p; )
                g[f++] = a[b++];
            if (p !== p)
                for (; void 0 !== a[b]; )
                    g[f++] = a[b++];
        ...
        proxy: function(g, a) {
            var p, b;
            "string" === typeof a && (b = g[a],
            a = g,
            g = b);
            if (f.isFunction(g))
                return p = n.call(arguments, 2),
                b = function() {
    ...
    var Pb = a, D = function(g, a, p, b) {
            ...
            if (f = gd.exec(g))
                if (k = f[1])
                    if (9 === d)
                        ...
                        if (a.ownerDocument && (c = a.ownerDocument.getElementById(k)) && ra(a, c) && c.id === k)
                            return p.push(c),
                            p
                    }
                else {
                    if (f[2])
                        return Ea.apply(p, a.getElementsByTagName(g)),
                        p;
                    if ((k = f[3]) && G.getElementsByClassName && a.getElementsByClassName)
                        return Ea.apply(p, a.getElementsByClassName(k)),
                        p
                }
            if (G.qsa && (!Q || !Q.test(g))) {
                c = f = I;
                ...
                if (n)
                    try {
                        return Ea.apply(p, k.querySelectorAll(n)),
                        p
                    } catch (e) {} finally {
        ...
        a: {
            ...
            if (!b && 1 === c.length) {
                f = c[0] = c[0].slice(0);
                if (2 < f.length && "ID" === (r = f[0]).type && G.getById && 9 === a.nodeType && Z && F.relative[f[1].type]) {
                ...
                for (d = xb.needsContext.test(g) ? 0 : f.length; d--; ) {
                    r = f[d];
                    if (F.relative[k = r.type])
                        break;
                    if (k = F.find[k])
                        if (b = k(r.matches[0].replace(Fa, Ga), Qb.test(f[0].type) && ha(a.parentNode) || a)) {
                            f.splice(d, 1);
                            g = b.length && vb(f);
                            if (!g) {
                                Ea.apply(p, b);
        ...
        for (var p = g.split("|"), b = g.length; b--; )
            F.attrHandle[p[b]] = a
    }, pc = function(g, a) {
        var p = a && g
          , b = p && 1 === g.nodeType && 1 === a.nodeType && (~a.sourceIndex || S) - (~g.sourceIndex || S);
        if (b)
            return b;
        if (p)
            for (; p = p.nextSibling; )
    ...
    }, qc = function() {}, sa = function(g, a) {
        var p, b, f, c, k, d, n;
        if (k = Ha[g + " "])
            return a ? 0 : k.slice(0);
        k = g;
        d = [];
        for (n = F.preFilter; k; ) {
            if (!p || (b = kd.exec(k)))
                b && (k = k.slice(b[0].length) || k),
                d.push(f = []);
            p = !1;
            if (b = ld.exec(k))
                p = b.shift(),
        ...
        for (var a = 0, p = g.length, b = ""; a < p; a++)
            b += g[a].value;
        return b
    }, Tb = function(g, a, p) {
        var b = a.dir
        ...
        return R(function(c, k, d, n) {
            var e, r, qa = [], h = [], l = k.length, q;
            if (!(q = c)) {
                q = a || "*";
                for (var j = d.nodeType ? [d] : d, A = [], z = 0, T = j.length; z < T; z++)
                    D(q, j[z], A);
                q = A
            }
            ...
            if (c) {
                ...
                j = Sa(j === k ? j.splice(l, j.length) : j),
                f ? f(null, k, j, n) : Ea.apply(k, j)
        })
    }, Wb = function(g) {
        var a, p, b, f = g.length, c = F.relative[g[0].type];
        p = c || F.relative[" "];
        for (var k = c ? 1 : 0, d = Tb(function(g) {
            ...
            return !c && (b || p !== ya) || ((a = p).nodeType ? d(g, p, b) : n(g, p, b))
        }
        ]; k < f; k++)
            if (p = F.relative[g[k].type])
                e = [Tb(Ub(e), p)];
            else {
        ...
        return Ub(e)
    }, za, G, F, Ia, rc, $a, ya, pa, Aa, na, P, ia, Z, Q, ea, Ja, ra, I = "sizzle" + -new Date, Y = Pb.document, da = 0, md = 0, sc = Rb(), Ha = Rb(), Ba = Rb(), A = function(g, a) {
        g === a && (Aa = !0);
        return 0
    }, T = "undefined", S = -2147483648, fa = {}.hasOwnProperty, M = [], aa = M.pop, nd = M.push, Ea = M.push, tc = M.slice, Ta = M.indexOf || function(g) {
        for (var a = 0, p = this.length; a < p; a++)
            if (this[a] === g)
                return a;
        return -1
    }
    , uc = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w", "w#"), vc = "\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + uc + ")|)|)[\\x20\\t\\r\\n\\f]*\\]", Xb = ":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + vc.replace(3, 8) + ")*)|.*)\\)|)", wb = RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$", "g"), kd = /^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/, ld = /^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/, od = RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*?)[\\x20\\t\\r\\n\\f]*\\]", "g"), pd = RegExp(Xb), qd = RegExp("^" + uc + "$"), xb = {
        ID: /^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,
        CLASS: /^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,
    ...
    na = D.setDocument = function(g) {
        ...
        g = a.defaultView;
        if (a === P || 9 !== a.nodeType || !a.documentElement)
            return P;
        P = a;
        ...
        G.getElementsByClassName = lb.test(a.getElementsByClassName) && oa(function(g) {
        ...
        G.getById ? (F.find.ID = function(g, a) {
        ...
        F.find.TAG = G.getElementsByTagName ? function(g, a) {
            if (typeof a.getElementsByTagName !== T)
                return a.getElementsByTagName(g)
        }
        : function(g, a) {
            var b, w = [], f = 0, c = a.getElementsByTagName(g);
            if ("*" === g) {
                for (; b = c[f++]; )
                    1 === b.nodeType && w.push(b);
                return w
            }
            return c
        }
        ;
        F.find.CLASS = G.getElementsByClassName && function(g, a) {
        ...
        if (G.qsa = lb.test(a.querySelectorAll))
            oa(function(g) {
                ...
                g.querySelectorAll("[t^='']").length && Q.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");
                g.querySelectorAll("[selected]").length || Q.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
            ...
            oa(function(g) {
                ...
                g.querySelectorAll("[name=d]").length && Q.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");
                g.querySelectorAll(":enabled").length || Q.push(":enabled", ":disabled");
                g.querySelectorAll("*,:x");
                Q.push(",.*:")
            });
        (G.matchesSelector = lb.test(Ja = ia.webkitMatchesSelector || ia.mozMatchesSelector || ia.oMatchesSelector || ia.msMatchesSelector)) && oa(function(g) {
        ...
        ra = (g = lb.test(ia.compareDocumentPosition)) || lb.test(ia.contains) ? function(g, a) {
            var b = 9 === g.nodeType ? g.documentElement : g
              , w = a && a.parentNode;
            return g === w || !(!w || !(1 === w.nodeType && (b.contains ? b.contains(w) : g.compareDocumentPosition && g.compareDocumentPosition(w) & 16)))
        }
        : function(g, a) {
            if (a)
                for (; a = a.parentNode; )
        ...
        A = g ? function(g, b) {
            ...
            return f & 1 || !G.sortDetached && b.compareDocumentPosition(g) === f ? g === a || g.ownerDocument === Y && ra(Y, g) ? -1 : b === a || b.ownerDocument === Y && ra(Y, b) ? 1 : pa ? Ta.call(pa, g) - Ta.call(pa, b) : 0 : f & 4 ? -1 : 1
        }
        : function(g, b) {
            if (g === b)
                return Aa = !0,
            ...
            var k = b.parentNode
              ...
              , n = [b];
            if (!f || !k)
                return g === a ? -1 : b === a ? 1 : f ? -1 : k ? 1 : pa ? Ta.call(pa, g) - Ta.call(pa, b) : 0;
            if (f === k)
                return pc(g, b);
            for (f = g; f = f.parentNode; )
                d.unshift(f);
    ...
    D.matchesSelector = function(g, a) {
        ...
        if (G.matchesSelector && Z && (!ea || !ea.test(a)) && (!Q || !Q.test(a)))
            try {
                var b = Ja.call(g, a);
                if (b || G.disconnectedMatch || g.document && 11 !== g.document.nodeType)
                    return b
            } catch (f) {}
    ...
    D.attr = function(g, a) {
        ...
        return void 0 !== b ? b : G.attributes || !Z ? g.getAttribute(a) : (b = g.getAttributeNode(a)) && b.specified ? b.value : null
    }
    ;
    D.error = function(g) {
    ...
    F = D.selectors = {
        ...
        preFilter: {
            ...
            CHILD: function(g) {
                g[1] = g[1].toLowerCase();
                "nth" === g[1].slice(0, 3) ? (g[3] || D.error(g[0]),
                g[4] = +(g[4] ? g[5] + (g[6] || 1) : 2 * ("even" === g[3] || "odd" === g[3])),
                g[5] = +(g[7] + g[8] || "odd" === g[3])) : g[3] && D.error(g[0]);
                return g
            },
            PSEUDO: function(g) {
                var a, b = !g[5] && g[2];
                if (xb.CHILD.test(g[0]))
                    return null;
                if (g[3] && void 0 !== g[4])
                    g[2] = g[4];
                else if (b && pd.test(b) && (a = sa(b, !0)) && (a = b.indexOf(")", b.length - a) - b.length))
                    g[0] = g[0].slice(0, a),
                    g[2] = b.slice(0, a);
                return g.slice(0, 3)
            }
        ...
        filter: {
            ...
            CLASS: function(g) {
                ...
                return a || (a = RegExp("(^|[\\x20\\t\\r\\n\\f])" + g + "([\\x20\\t\\r\\n\\f]|$)")) && sc(g, function(g) {
                    return a.test("string" === typeof g.className && g.className || typeof g.getAttribute !== T && g.getAttribute("class") || "")
                })
            },
            ATTR: function(g, a, b) {
                return function(f) {
            ...
            PSEUDO: function(g, a) {
                var b, f = F.pseudos[g] || F.setFilters[g.toLowerCase()] || D.error("unsupported pseudo: " + g);
                return f[I] ? f(a) : 1 < f.length ? (b = [g, g, "", a],
                F.setFilters.hasOwnProperty(g.toLowerCase()) ? R(function(g, b) {
        ...
        pseudos: {
            ...
            lang: R(function(g) {
                ...
                return function(a) {
                    var b;
                    do
                        if (b = Z ? a.lang : a.getAttribute("xml:lang") || a.getAttribute("lang"))
            ...
            focus: function(g) {
                return g === P.activeElement && (!P.hasFocus || P.hasFocus()) && !(!g.type && !g.href && !~g.tabIndex)
            },
            enabled: function(g) {
                return !1 === g.disabled
            },
    ...
    $a = D.compile = function(g, a) {
        ...
        if (!k) {
            ...
            for (b = a.length; b--; )
                k = Wb(a[b]),
                k[I] ? f.push(k) : c.push(k);
            var d = 0 < f.length
              , n = 0 < c.length;
            b = function(g, a, b, p, w) {
                var k, e, r, h = 0, q = "0", j = g && [], qa = [], l = ya, A = g || n && F.find.TAG("*", w), z = da += null == l ? 1 : Math.random() || 0.1, T = A.length;
    ...
    oa(function(g) {
        ...
        if (!b)
            return g.getAttribute(a, "type" === a.toLowerCase() ? 1 : 2)
    });
    (!G.attributes || !oa(function(g) {
        g.innerHTML = "<input/>";
        ...
        if (!b && "input" === g.nodeName.toLowerCase())
    ...
    oa(function(g) {
        ...
        var f;
        if (!b)
            return !0 === g[a] ? a.toLowerCase() : (f = g.getAttributeNode(a)) && f.specified ? f.value : null
    });
    f.find = D;
    f.expr = D.selectors;
    ...
    f.fn.extend({
        find: function(g) {
            var a, b = [], c = this, k = c.length;
            if ("string" !== typeof g)
                return this.pushStack(f(g).filter(function() {
                    for (a = 0; a < k; a++)
                        if (f.contains(c[a], this))
                            return !0
                }));
            for (a = 0; a < k; a++)
                f.find(g, c[a], b);
    ...
    var mb, y = a.document, td = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (f.fn.init = function(g, a) {
        ...
        if ("string" === typeof g) {
            if ((b = "<" === g.charAt(0) && ">" === g.charAt(g.length - 1) && 3 <= g.length ? [null, g, null] : td.exec(g)) && (b[1] || !a)) {
                if (b[1]) {
                    ...
                    f.merge(this, f.parseHTML(b[1], a && a.nodeType ? a.ownerDocument || a : y, !0)),
                    xc.test(b[1]) && f.isPlainObject(a))
                        for (b in a)
                            if (f.isFunction(this[b]))
                                this[b](a[b]);
                            else
                                this.attr(b, a[b])
                } else {
        ...
        if (g.nodeType)
            return this.context = this[0] = g,
            this.length = 1,
            this;
        if (f.isFunction(g))
            return "undefined" !== typeof mb.ready ? mb.ready(g) : g(f);
        void 0 !== g.selector && (this.selector = g.selector,
    ...
    f.extend({
        dir: function(g, a, b) {
            var c = [];
            for (g = g[a]; g && 9 !== g.nodeType && (void 0 === b || 1 !== g.nodeType || !f(g).is(b)); )
    ...
    f.fn.extend({
        ...
        index: function(g) {
            return !g ? this[0] && this[0].parentNode ? this.first().prevAll().length : -1 : "string" === typeof g ? f.inArray(this[0], f(g)) : f.inArray(g.jquery ? g[0] : g, this)
        },
        add: function(g, a) {
    ...
    f.each({
        ...
        f.fn[g] = function(b, c) {
            ...
            1 < this.length && (vd[g] || (k = f.unique(k)),
            ud.test(g) && (k = k.reverse()));
    ...
    f.Callbacks = function(g) {
        ...
        if ("string" === typeof g) {
            ...
            a = f.extend({}, g);
        g = a;
        var c, k, d, n, e, r, h = [], q = !g.once && [], j = function(a) {
            k = g.memory && a;
            d = !0;
            e = r || 0;
            r = 0;
                ...
                if (h) {
                    ...
                    (function $c(a) {
                        f.each(a, function(a, b) {
                            var p = f.type(b);
                            "function" === p ? (!g.unique || !l.has(b)) && h.push(b) : b && (b.length && "string" !== p) && $c(b)
                        })
                    }
                    )(arguments);
                    c ? n = h.length : k && (r = a,
    ...
    f.extend({
        Deferred: function(g) {
            var a = [["resolve", "done", f.Callbacks("once memory"), "resolved"], ["reject", "fail", f.Callbacks("once memory"), "rejected"], ["notify", "progress", f.Callbacks("memory")]]
              , b = "pending"
              , c = {
                state: function() {
                    return b
                        ...
                        f.each(a, function(a, p) {
                            ...
                            k[p[1]](function() {
                                ...
                                if (g && f.isFunction(g.promise))
                                    g.promise().done(b.resolve).fail(b.reject).progress(b.notify);
                                else
                                    b[p[0] + "With"](this === c ? b.promise() : this, w ? [g] : arguments)
                            })
                        });
                        g = null
                    }).promise()
        ...
        when: function(g) {
            var a = 0, b = n.call(arguments), c = b.length, k = 1 !== c || g && f.isFunction(g.promise) ? c : 0, d = 1 === k ? g : f.Deferred(), e = function(g, a, b) {
                return function(f) {
                    a[g] = this;
            ...
            if (1 < c) {
                ...
                h = Array(c);
                for (q = Array(c); a < c; a++)
                    b[a] && f.isFunction(b[a].promise) ? b[a].promise().done(e(a, q, b)).fail(d.reject).progress(e(a, h, r)) : --k
            }
            k || d.resolveWith(q, b);
            return d.promise()
        }
    ...
    f.extend({
        ...
        ready: function(g) {
            if (!(!0 === g ? --f.readyWait : f.isReady)) {
                ...
                f.isReady = !0;
                !0 !== g && 0 < --f.readyWait || (yb.resolveWith(y, [f]),
    ...
    f(function() {
        ...
        if (b) {
            ...
            if (typeof a.style.zoom !== ka && (a.style.cssText = "border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1",
    ...
    f.fn.extend({
        data: function(g, a) {
            var b, c, k, d = this[0], n = d && d.attributes;
            if (void 0 === g) {
                if (this.length && (k = f.data(d),
                1 === d.nodeType && !f._data(d, "parsedAttrs"))) {
                    for (b = n.length; b--; )
                        c = n[b].name,
                        0 === c.indexOf("data-") && (c = f.camelCase(c.slice(5)),
                        s(d, c, k[c]));
    ...
    f.extend({
        queue: function(g, a, b) {
            ...
            if (g)
                return a = (a || "fx") + "queue",
                c = f._data(g, a),
                b && (!c || f.isArray(b) ? c = f._data(g, a, f.makeArray(b)) : c.push(b)),
                c || []
        },
    ...
    f.fn.extend({
        ...
        promise: function(a, b) {
            var c, k = 1, d = f.Deferred(), n = this, e = this.length, r = function() {
                --k || d.resolveWith(n, [n])
            };
            "string" !== typeof a && (b = a,
            a = void 0);
    ...
    var zb = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
      ...
      , Ua = f.access = function(a, b, c, k, d, n, e) {
        ...
        if ("object" === f.type(c))
            for (r in d = !0,
            c)
                f.access(a, b, r, c[r], !0, n, e);
        else if (void 0 !== k && (d = !0,
        f.isFunction(k) || (e = !0),
        q && (e ? (b.call(a, k),
        b = null) : (q = b,
        b = function(a, g, b) {
        ...
        b))
            for (; r < h; r++)
                b(a[r], c, e ? k : k.call(a[r], r, b(a[r], c)));
    ...
    v.html5Clone = "<:nav></:nav>" !== y.createElement("nav").cloneNode(!0).outerHTML;
    nb.type = "checkbox";
    nb.checked = !0;
    Yb.appendChild(nb);
    ...
    v.noCloneEvent = !0;
    ba.attachEvent && (ba.attachEvent("onclick", function() {
        v.noCloneEvent = !1
    }),
    ...
    var Yb = ba = nb = null, Ab, Bb, Ac = y.createElement("div");
    for (Ab in {
        submit: !0,
        change: !0,
        focusin: !0
    ...
    f.event = {
        ...
        add: function(a, b, c, k, d) {
            ...
            if (r = f._data(a)) {
                ...
                if (!(e = r.events))
                    e = r.events = {};
                if (!(q = r.handle))
                    q = r.handle = function(a) {
                        return typeof f !== ka && (!a || f.event.triggered !== a.type) ? f.event.dispatch.apply(q.elem, arguments) : void 0
                    }
                    ,
                    q.elem = a;
                b = (b || "").match(va) || [""];
                    ...
                    A) {
                        ...
                        if (!(l = e[A]))
                            ...
                            !n.setup || !1 === n.setup.call(a, k, z, q))
                                a.addEventListener ? a.addEventListener(A, q, !1) : a.attachEvent && a.attachEvent("on" + A, q);
                        n.add && (n.add.call(a, j),
                        j.handler.guid || (j.handler.guid = c.guid));
        ...
        remove: function(a, b, c, k, d) {
            var n, e, r, h, q, j, l, A, z, T, t, K = f.hasData(a) && f._data(a);
            if (K && (j = K.events)) {
                b = (b || "").match(va) || [""];
                for (q = b.length; q--; )
                    if (r = Cc.exec(b[q]) || [],
                    ...
                    z) {
                        ...
                        for (h = n = A.length; n--; )
                            if (e = A[n],
                            (d || t === e.origType) && (!c || c.guid === e.guid) && (!r || r.test(e.namespace)) && (!k || k === e.selector || "**" === k && e.selector))
                                A.splice(n, 1),
                                e.selector && A.delegateCount--,
                                l.remove && l.remove.call(a, e);
                        h && !A.length && ((!l.teardown || !1 === l.teardown.call(a, T, K.handle)) && f.removeEvent(a, z, K.handle),
                        delete j[z])
                    } else
                        for (z in j)
                            f.event.remove(a, z + b[q], c, k, !0);
                f.isEmptyObject(j) && (delete K.handle,
                f._removeData(a, "events"))
            }
        },
        trigger: function(g, b, c, k) {
            var d, n, e, r, h, q, j = [c || y], l = xa.call(g, "type") ? g.type : g;
            h = xa.call(g, "namespace") ? g.namespace.split(".") : [];
            e = d = c = c || y;
            if (!(3 === c.nodeType || 8 === c.nodeType) && !Bc.test(l + f.event.triggered))
                if (0 <= l.indexOf(".") && (h = l.split("."),
                l = h.shift(),
                h.sort()),
                n = 0 > l.indexOf(":") && "on" + l,
                ...
                g.isTrigger = k ? 2 : 3,
                g.namespace = h.join("."),
                g.namespace_re = g.namespace ? RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null,
                g.result = void 0,
                g.target || (g.target = c),
                ...
                k || !(h.trigger && !1 === h.trigger.apply(c, b))) {
                    ...
                    for (q = 0; (e = j[q++]) && !g.isPropagationStopped(); )
                        if (g.type = 1 < q ? r : h.bindType || l,
                        (d = (f._data(e, "events") || {})[g.type] && f._data(e, "handle")) && d.apply(e, b),
                        (d = n && e[n]) && d.apply && f.acceptData(e))
                            g.result = d.apply(e, b),
        ...
        dispatch: function(a) {
            a = f.event.fix(a);
            var b, c, k, d, e = [], r = n.call(arguments);
            ...
            if (!(h.preDispatch && !1 === h.preDispatch.call(this, a))) {
                ...
                for (b = 0; (k = e[b++]) && !a.isPropagationStopped(); ) {
                    ...
                    for (d = 0; (c = k.handlers[d++]) && !a.isImmediatePropagationStopped(); )
                        if (!a.namespace_re || a.namespace_re.test(c.namespace))
                            if (a.handleObj = c,
                            a.data = c.data,
                            c = ((f.event.special[c.origType] || {}).handle || c.handler).apply(k.elem, r),
        ...
        handlers: function(a, b) {
            var c, k, d, n, e = [], r = b.delegateCount, h = a.target;
                ...
                for (; h != this; h = h.parentNode || this)
                    if (1 === h.nodeType && (!0 !== h.disabled || "click" !== a.type)) {
                        ...
                        for (n = 0; n < r; n++)
                            k = b[n],
                            c = k.selector + " ",
                            void 0 === d[c] && (d[c] = k.needsContext ? 0 <= f(c, this).index(h) : f.find(c, this, null, [h]).length),
                            d[c] && d.push(k);
                        d.length && e.push({
                            elem: h,
                            handlers: d
        ...
        mouseHooks: {
            ...
            filter: function(a, b) {
                var f, c, k = b.button, d = b.fromElement;
                null == a.pageX && null != b.clientX && (f = a.target.ownerDocument || y,
                c = f.documentElement,
                f = f.body,
                a.pageX = b.clientX + (c && c.scrollLeft || f && f.scrollLeft || 0) - (c && c.clientLeft || f && f.clientLeft || 0),
                a.pageY = b.clientY + (c && c.scrollTop || f && f.scrollTop || 0) - (c && c.clientTop || f && f.clientTop || 0));
        ...
        special: {
            ...
            click: {
                trigger: function() {
                    if (f.nodeName(this, "input") && "checkbox" === this.type && this.click)
                        return this.click(),
                        !1
                },
                _default: function(a) {
    ...
    : function(a, b, f) {
        b = "on" + b;
        a.detachEvent && (typeof a[b] === ka && (a[b] = null),
        a.detachEvent(b, f))
    }
    ;
    f.Event = function(a, b) {
        ...
        this.type = a.type,
        this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && (!1 === a.returnValue || a.getPreventDefault && a.getPreventDefault()) ? d : q) : this.type = a;
        b && f.extend(this, b);
    ...
    f.each({
        ...
        f.event.special[a] = {
            ...
            bindType: b,
            handle: function(a) {
                var g, c = a.relatedTarget, k = a.handleObj;
    ...
    v.submitBubbles || (f.event.special.submit = {
        setup: function() {
            ...
            f.event.add(this, "click._submit keypress._submit", function(a) {
                a = a.target;
                if ((a = f.nodeName(a, "input") || f.nodeName(a, "button") ? a.form : void 0) && !f._data(a, "submitBubbles"))
    ...
    v.focusinBubbles || f.each({
        ...
        f.event.special[b] = {
            ...
            teardown: function() {
                var k = this.ownerDocument || this
                  , d = f._data(k, b) - 1;
                d ? f._data(k, b, d) : (k.removeEventListener(a, c, !0),
                f._removeData(k, b))
            }
        }
    });
    f.fn.extend({
        on: function(a, b, c, k, d) {
            ...
            null == c && null == k ? (k = b,
            c = b = void 0) : null == k && ("string" === typeof b ? (k = c,
            c = void 0) : (k = c,
            c = b,
            b = void 0));
            if (!1 === k)
        ...
        off: function(a, b, c) {
            ...
            if (a && a.preventDefault && a.handleObj)
                return k = a.handleObj,
                f(a.delegateTarget).off(k.namespace ? k.origType + "." + k.namespace : k.origType, k.selector, k.handler),
                this;
            if ("object" === typeof a) {
                for (k in a)
                    this.off(k, b, a[k]);
        ...
        triggerHandler: function(a, b) {
            var c = this[0];
            if (c)
                return f.event.trigger(a, b, c, !0)
        }
    });
    ...
    f.extend({
        clone: function(a, b, c) {
            ...
            v.html5Clone || f.isXMLDoc(a) || !Dc.test("<" + a.nodeName + ">") ? n = a.cloneNode(!0) : (ac.innerHTML = a.outerHTML,
            ac.removeChild(n = ac.firstChild));
            if ((!v.noCloneEvent || !v.noCloneChecked) && (1 === a.nodeType || 11 === a.nodeType) && !f.isXMLDoc(a)) {
                k = C(n);
                r = C(a);
                    ...
                    if (k[e]) {
                        ...
                        if (1 === q.nodeType) {
                            ...
                            if ("script" === l && q.text !== d.text)
                                ...
                                v.html5Clone && (d.innerHTML && !f.trim(q.innerHTML)) && (q.innerHTML = d.innerHTML);
        ...
        buildFragment: function(a, b, c, k) {
            for (var d, n, e, r, h, q, l = a.length, j = U(b), A = [], z = 0; z < l; z++)
                if ((n = a[z]) || 0 === n)
                    if ("object" === f.type(n))
                        f.merge(A, n.nodeType ? [n] : n);
                    else if (Ad.test(n)) {
                        ...
                        for (d = q[0]; d--; )
                            e = e.lastChild;
                        !v.leadingWhitespace && $b.test(n) && A.push(b.createTextNode($b.exec(n)[0]));
                        if (!v.tbody)
                            for (d = (n = "table" === r && !Gc.test(n) ? e.firstChild : "<table>" === q[1] && !Gc.test(n) ? e : 0) && n.childNodes.length; d--; )
                                f.nodeName(h = n.childNodes[d], "tbody") && !h.childNodes.length && n.removeChild(h);
                        f.merge(A, e.childNodes);
                        for (e.textContent = ""; e.firstChild; )
                            e.removeChild(e.firstChild);
                        e = j.lastChild
                    } else
                        A.push(b.createTextNode(n));
            e && j.removeChild(e);
            v.appendChecked || f.grep(C(A, "input"), rb);
            for (z = 0; n = A[z++]; )
                if (!(k && -1 !== f.inArray(n, k)) && (a = f.contains(n.ownerDocument, n),
                e = C(j.appendChild(n), "script"),
                a && O(e),
                c))
                    for (d = 0; n = e[d++]; )
                        Hc.test(n.type || "") && c.push(n);
            return j
        },
        cleanData: function(a, b) {
            for (var c, d, n, e, r = 0, h = f.expando, q = f.cache, l = v.deleteExpando, j = f.event.special; null != (c = a[r]); r++)
                if (b || f.acceptData(c))
                    if (e = (n = c[h]) && q[n]) {
                        if (e.events)
                            for (d in e.events)
                        ...
                        q[n] && (delete q[n],
                        l ? delete c[h] : typeof c.removeAttribute !== ka ? c.removeAttribute(h) : c[h] = null,
                        k.push(n))
                    }
        }
    });
    f.fn.extend({
        ...
        remove: function(a, b) {
            for (var c, k = a ? f.filter(a, this) : this, d = 0; null != (c = k[d]); d++)
                !b && 1 === c.nodeType && f.cleanData(C(c)),
                c.parentNode && (b && f.contains(c.ownerDocument, c) && O(C(c, "script")),
        ...
        html: function(a) {
            return Ua(this, function(a) {
                ...
                if ("string" === typeof a && !Bd.test(a) && (v.htmlSerialize || !Dc.test(a)) && (v.leadingWhitespace || !$b.test(a)) && !ja[(Fc.exec(a) || ["", ""])[1].toLowerCase()]) {
                    a = a.replace(Ec, "<$1></$2>");
                    try {
                        for (; b < c; b++)
                            g = this[b] || {},
                            1 === g.nodeType && (f.cleanData(C(g, !1)),
                            g.innerHTML = a);
                        g = 0
                    } catch (k) {}
                }
        ...
        domManip: function(a, b) {
            a = r.apply([], a);
            var c, k, d, n, e = 0, h = this.length, q = this, l = h - 1, j = a[0], A = f.isFunction(j);
            ...
            if (h && (n = f.buildFragment(a, this[0].ownerDocument, !1, this),
            c = n.firstChild,
            ...
            c)) {
                ...
                if (k) {
                    ...
                    for (e = 0; e < k; e++)
                        if (c = d[e],
                        Hc.test(c.type || "") && !f._data(c, "globalEval") && f.contains(n, c))
                            c.src ? f._evalUrl && f._evalUrl(c.src) : f.globalEval((c.text || c.textContent || c.innerHTML || "").replace(Dd, ""))
                }
                n = c = null
            }
            return this
    ...
    var eb, nc = {}, ob, Cb, ab = y.createElement("div");
    ...
    v.shrinkWrapBlocks = function() {
        ...
        if (null == Cb) {
            ...
            Cb = !1;
            typeof c.style.zoom !== ka && (c.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0;width:1px;padding:1px;zoom:1",
            c.innerHTML = "<div></div>",
    ...
    ;
    var Ic = /^margin/, sb = RegExp("^(" + zb + ")(?!px)[a-z%]+$", "i"), Pa, Qa, Ed = /^(top|right|bottom|left)$/;
    a.getComputedStyle ? (Pa = function(a) {
    ...
    Qa = function(a, b, c) {
        ...
        c && ("" === d && !f.contains(a.ownerDocument, a) && (d = f.style(a, b)),
        sb.test(d) && Ic.test(b) && (a = n.width,
        b = n.minWidth,
        k = n.maxWidth,
    ...
    ) : y.documentElement.currentStyle && (Pa = function(a) {
    ...
    var dc = function() {
        ...
        Eb = !1,
        Fb = !0,
        a.getComputedStyle && (Eb = "1%" !== (a.getComputedStyle(b, null) || {}).top,
        Db = "4px" === (a.getComputedStyle(b, null) || {
            width: "4px"
        }).width),
        c.removeChild(g),
        b = c = null)
    }, pb, Gb, cc, Db, Eb, Fb, bb = y.createElement("div"), bc = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px";
    ...
    f.extend(v, {
        ...
        reliableMarginRight: function() {
            ...
            if (null == Fb && a.getComputedStyle) {
                ...
                f.style.cssText = c.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0";
    ...
    f.extend({
        ...
        style: function(a, b, c, k) {
            if (a && !(3 === a.nodeType || 8 === a.nodeType || !a.style)) {
                var d, n, e, r = f.camelCase(b), h = a.style;
                b = f.cssProps[r] || (f.cssProps[r] = gb(h, r));
                e = f.cssHooks[b] || f.cssHooks[r];
                if (void 0 !== c) {
                    n = typeof c;
                    if ("string" === n && (d = Hd.exec(c)))
                        c = (d[1] + 1) * d[2] + parseFloat(f.css(a, b)),
                        n = "number";
                    if (!(null == c || c !== c))
                        if ("number" === n && !f.cssNumber[r] && (c += "px"),
                        !v.clearCloneStyle && ("" === c && 0 === b.indexOf("background")) && (h[b] = "inherit"),
        ...
        css: function(a, b, c, k) {
            ...
            return "" === c || c ? (a = parseFloat(d),
            !0 === c || f.isNumeric(a) ? a || 0 : d) : d
        }
    });
    f.each(["height", "width"], function(a, b) {
        f.cssHooks[b] = {
            get: function(a, g, c) {
                if (g)
                    return 0 === a.offsetWidth && Gd.test(f.css(a, "display")) ? f.swap(a, Id, function() {
                        return W(a, b, c)
                    }) : W(a, b, c)
            },
            set: function(a, g, c) {
                var k = c && Pa(a);
                return la(a, g, c ? x(a, b, c, v.boxSizing() && "border-box" === f.css(a, "boxSizing", !1, k), k) : 0)
            }
        }
    });
    ...
    f.fn.extend({
        css: function(a, b) {
            return Ua(this, function(a, b, g) {
                var c, k = {}, d = 0;
                if (f.isArray(b)) {
                    g = Pa(a);
                    for (c = b.length; d < c; d++)
                        k[b[d]] = f.css(a, b[d], !1, g);
                    return k
                }
        ...
        _default: {
            ...
            set: function(a) {
                if (f.fx.step[a.prop])
                    ...
                    a.elem.style && (null != a.elem.style[f.cssProps[a.prop]] || f.cssHooks[a.prop]) ? f.style(a.elem, a.prop, a.now + a.unit) : a.elem[a.prop] = a.now
            }
        }
    };
    ...
    f.fx.step = {};
    var Za, Hb, Jd = /^(?:toggle|show|hide)$/, Kc = RegExp("^(?:([+-])=|)(" + zb + ")([a-z%]*)$", "i"), Kd = /queueHooks$/, tb = [function(a, b, c) {
        var k, d, n, e, r, h, q = this, j = {}, l = a.style, A = a.nodeType && hb(a), z = f._data(a, "fxshow");
        c.queue || (e = f._queueHooks(a, "fx"),
        ...
        if (1 === a.nodeType && ("height"in b || "width"in b))
            ...
            h = db(a.nodeName),
            "none" === d && (d = h),
            "inline" === d && "none" === f.css(a, "float") && (!v.inlineBlockNeedsLayout || "inline" === h ? l.display = "inline-block" : l.zoom = 1);
        c.overflow && (l.overflow = "hidden",
        v.shrinkWrapBlocks() || q.always(function() {
        ...
        if (!f.isEmptyObject(j))
            for (k in z ? "hidden"in z && (A = z.hidden) : z = f._data(a, "fxshow", {}),
            n && (z.hidden = !A),
            A ? f(a).show() : q.done(function() {
                f(a).hide()
            }),
            q.done(function() {
                var b;
    ...
    f.fn.extend({
        ...
        finish: function(a) {
            !1 !== a && (a = a || "fx");
            return this.each(function() {
                var b, c = f._data(this), k = c[a + "queue"];
                b = c[a + "queueHooks"];
                var d = f.timers
                  , n = k ? k.length : 0;
                c.finish = !0;
                ...
                for (b = d.length; b--; )
                    ...
                    d.splice(b, 1));
                for (b = 0; b < n; b++)
                    k[b] && k[b].finish && k[b].finish.call(this);
                delete c.finish
            })
        }
    });
    f.each(["toggle", "show", "hide"], function(a, b) {
        ...
        f.fn[b] = function(a, g, k) {
            return null == a || "boolean" === typeof a ? c.apply(this, arguments) : this.animate(L(b, !0), a, g, k)
        }
    });
    f.each({
        slideDown: L("show"),
    ...
    ;
    var Ib, Ka, fc, gc, qb = y.createElement("div");
    ...
    f.fn.extend({
        val: function(a) {
            var b, c, k, d = this[0];
            if (arguments.length)
                return k = f.isFunction(a),
                this.each(function(c) {
                    if (1 === this.nodeType && (c = k ? a.call(this, c, f(this).val()) : a,
                    null == c ? c = "" : "number" === typeof c ? c += "" : f.isArray(c) && (c = f.map(c, function(a) {
                        return null == a ? "" : a + ""
                    })),
            ...
            if (d) {
                if ((b = f.valHooks[d.type] || f.valHooks[d.nodeName.toLowerCase()]) && "get"in b && void 0 !== (c = b.get(d, "value")))
                    return c;
                c = d.value;
            ...
            select: {
                get: function(a) {
                    for (var b, c = a.options, k = a.selectedIndex, d = (a = "select-one" === a.type || 0 > k) ? null : [], n = a ? k + 1 : c.length, e = 0 > k ? n : a ? k : 0; e < n; e++)
                        if (b = c[e],
                        (b.selected || e === k) && (v.optDisabled ? !b.disabled : null === b.getAttribute("disabled")) && (!b.parentNode.disabled || !f.nodeName(b.parentNode, "optgroup"))) {
                            b = f(b).val();
                            if (a)
                                return b;
                            d.push(b)
                ...
                set: function(a, b) {
                    for (var c, k, d = a.options, n = f.makeArray(b), e = d.length; e--; )
                        if (k = d[e],
                        0 <= f.inArray(f.valHooks.option.get(k), n))
                            try {
                                k.selected = c = !0
                            } catch (r) {
                                k.scrollHeight
    ...
    var cb, Lc, La = f.expr.attrHandle, hc = /^(?:checked|selected)$/i, Va = v.getSetAttribute, Jb = v.input;
    f.fn.extend({
        attr: function(a, b) {
    ...
    f.extend({
            ...
            if (a && !(3 === n || 8 === n || 2 === n)) {
                ...
                if (void 0 !== c)
                    if (null === c)
                        ...
                        if (k && "set"in k && void 0 !== (d = k.set(a, c, b)))
                            return d;
                        a.setAttribute(b, c + "");
                        return c
                    }
                else {
                    if (k && "get"in k && null !== (d = k.get(a, b)))
                        return d;
                    d = f.find.attr(a, b);
        ...
        removeAttr: function(a, b) {
            var c, k, d = 0, n = b && b.match(va);
            if (n && 1 === a.nodeType)
                for (; c = n[d++]; )
                    k = f.propFix[c] || c,
                    f.expr.match.bool.test(c) ? Jb && Va || !hc.test(c) ? a[k] = !1 : a[f.camelCase("default-" + c)] = a[k] = !1 : f.attr(a, c, ""),
    ...
    Lc = {
        set: function(a, b, c) {
            !1 === b ? f.removeAttr(a, c) : Jb && Va || !hc.test(c) ? a.setAttribute(!Va && f.propFix[c] || c, c) : a[f.camelCase("default-" + c)] = a[c] = !0;
            return c
        }
    };
    f.each(f.expr.match.bool.source.match(/\w+/g), function(a, b) {
        var c = La[b] || f.find.attr;
        La[b] = Jb && Va || !hc.test(b) ? function(a, b, g) {
            var k, f;
            g || (f = La[b],
            La[b] = k,
    ...
    La.id = La.name = La.coords = function(a, b, c) {
        var k;
        if (!c)
            return (k = a.getAttributeNode(b)) && "" !== k.value ? k.value : null
    }
    ,
    f.valHooks.button = {
        get: function(a, b) {
    ...
    v.hrefNormalized || f.each(["href", "src"], function(a, b) {
        f.propHooks[b] = {
            get: function(a) {
    ...
    f.fn.extend({
        addClass: function(a) {
            var b, c, k, d, n, e = 0, r = this.length;
            b = "string" === typeof a && a;
            if (f.isFunction(a))
            ...
            if (b)
                for (b = (a || "").match(va) || []; e < r; e++)
                    if (c = this[e],
                    k = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(ic, " ") : " ")) {
                        for (n = 0; d = b[n++]; )
                            0 > k.indexOf(" " + d + " ") && (k += d + " ");
                        k = f.trim(k);
        ...
        toggleClass: function(a, b) {
            ...
            return "boolean" === typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : f.isFunction(a) ? this.each(function(c) {
                ...
                if ("string" === c)
                    for (var b, k = 0, d = f(this), n = a.match(va) || []; b = n[k++]; )
                        d.hasClass(b) ? d.removeClass(b) : d.addClass(b);
                else if (c === ka || "boolean" === c)
                    this.className && f._data(this, "__className__", this.className),
                    this.className = this.className || !1 === a ? "" : f._data(this, "__className__") || ""
            })
        },
        hasClass: function(a) {
            a = " " + a + " ";
            for (var b = 0, c = this.length; b < c; b++)
                if (1 === this[b].nodeType && 0 <= (" " + this[b].className + " ").replace(ic, " ").indexOf(a))
                    return !0;
            return !1
        }
    });
    ...
    f.parseXML = function(b) {
        ...
        if (!b || "string" !== typeof b)
            return null;
        try {
            a.DOMParser ? (k = new DOMParser,
            c = k.parseFromString(b, "text/xml")) : (c = new ActiveXObject("Microsoft.XMLDOM"),
            c.async = "false",
            c.loadXML(b))
        } catch (d) {
            c = void 0
    ...
    ;
    var Wa, Ma, Pd = /#.*$/, Mc = /([?&])_=[^&]*/, Qd = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, Rd = /^(?:GET|HEAD)$/, Sd = /^\/\//, Nc = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Oc = {}, Nb = {}, Pc = "*/".concat("*");
    try {
        Ma = location.href
    } catch (be) {
        Ma = y.createElement("a"),
        Ma.href = "",
        Ma = Ma.href
    }
        ...
        ajax: function(a, b) {
            function c(a, b, g, k) {
                ...
                if (2 !== fa) {
                    ...
                    if (g) {
                        p = j;
                        for (var M = s, S, w, E, C, U = p.contents, N = p.dataTypes; "*" === N[0]; )
                            N.shift(),
                            void 0 === w && (w = p.mimeType || M.getResponseHeader("Content-Type"));
                        if (w)
                            for (C in U)
                                if (U[C] && U[C].test(w)) {
                                    N.unshift(C);
                    ...
                    a: {
                        ...
                        w = s;
                        E = k;
                        var v, aa, u, M = {}, U = g.dataTypes.slice();
                        if (U[1])
                            for (aa in g.converters)
                                M[aa.toLowerCase()] = g.converters[aa];
                        for (C = U.shift(); C; )
                            if (g.responseFields[C] && (w[g.responseFields[C]] = S),
                            ...
                            C = U.shift())
                                if ("*" === C)
                                    ...
                                    if (!aa)
                                        for (v in M)
                                            if (p = v.split(" "),
                                            p[1] === C && (aa = M[u + " " + p[0]] || M["* " + p[0]])) {
                                                !0 === aa ? aa = M[v] : !0 !== M[v] && (C = p[0],
                                                U.unshift(p[1]));
                                                break
                                            }
                                    if (!0 !== aa)
                                        if (aa && g["throws"])
                                            ...
                                            try {
                                                ...
                                                p = {
                                                    state: "parsererror",
                                                    error: aa ? Xa : "No conversion from " + u + " to " + C
                                                };
                                                break a
                                            }
                                }
                    ...
                    if (k)
                        j.ifModified && ((m = s.getResponseHeader("Last-Modified")) && (f.lastModified[n] = m),
                        (m = s.getResponseHeader("etag")) && (f.etag[n] = m)),
                        204 === a || "HEAD" === j.type ? m = "nocontent" : 304 === a ? m = "notmodified" : (m = p.state,
                        d = p.data,
                        l = p.error,
                        k = !l);
                    else if (l = m,
            ...
            a = void 0);
            b = b || {};
            var k, d, n, e, r, h, q, l, j = f.ajaxSetup({}, b), A = j.context || j, z = j.context && (A.nodeType || A.jquery) ? f(A) : f.event, T = f.Deferred(), t = f.Callbacks("once memory"), K = j.statusCode || {}, m = {}, M = {}, fa = 0, S = "canceled", s = {
                readyState: 0,
            ...
            s.success = s.done;
            s.error = s.fail;
            j.url = ((a || j.url || Ma) + "").replace(Pd, "").replace(Sd, Wa[1] + "//");
            j.type = b.method || b.type || j.method || j.type;
            j.dataTypes = f.trim(j.dataType || "*").toLowerCase().match(va) || [""];
            null == j.crossDomain && (k = Nc.exec(j.url.toLowerCase()),
            j.crossDomain = !(!k || !(k[1] !== Wa[1] || k[2] !== Wa[2] || (k[3] || ("http:" === k[1] ? "80" : "443")) !== (Wa[3] || ("http:" === Wa[1] ? "80" : "443")))));
            ...
            n = j.url;
            j.hasContent || (j.data && (n = j.url += (kc.test(n) ? "&" : "?") + j.data,
            delete j.data),
            !1 === j.cache && (j.url = Mc.test(n) ? n.replace(Mc, "$1_=" + jc++) : n + (kc.test(n) ? "&" : "?") + "_=" + jc++));
            j.ifModified && (f.lastModified[n] && s.setRequestHeader("If-Modified-Since", f.lastModified[n]),
            f.etag[n] && s.setRequestHeader("If-None-Match", f.etag[n]));
            (j.data && j.hasContent && !1 !== j.contentType || b.contentType) && s.setRequestHeader("Content-Type", j.contentType);
            ...
            for (d in j.headers)
                s.setRequestHeader(d, j.headers[d]);
    ...
    f.expr.filters.hidden = function(a) {
        return 0 >= a.offsetWidth && 0 >= a.offsetHeight || !v.reliableHiddenOffsets() && "none" === (a.style && a.style.display || f.css(a, "display"))
    }
    ;
    ...
    f.ajaxSettings.xhr = void 0 !== a.ActiveXObject ? function() {
        var b;
        if (!(b = !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && X()))
            a: {
                try {
    ...
    : X;
    f.ajaxSettings.xhr = void 0 === a.ActiveXObject ? B : function() {
        return (this.url == y.location || 0 == this.url.indexOf("http") || !this.isLocal) && /^(get|post|head|put|delete|options)$/i.test(this.type) && B() || B(1)
    }
    ;
    var Wd = 0
      , Kb = {}
    ...
    (Lb = v.ajax = !!Lb) && f.ajaxTransport(function(a) {
        if (!a.crossDomain || v.cors) {
            ...
            return {
                send: function(c, k) {
                    ...
                    for (d in c)
                        void 0 !== c[d] && n.setRequestHeader(d, c[d] + "");
    ...
    f.ajaxTransport("script", function(a) {
        if (a.crossDomain) {
            var b, c = y.head || f("head")[0] || y.documentElement;
            return {
                send: function(k, d) {
    ...
    f.ajaxPrefilter("json jsonp", function(b, c, k) {
        ...
        if (r || "jsonp" === b.dataTypes[0])
            return d = b.jsonpCallback = f.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback,
            r ? b[r] = b[r].replace(lc, "$1" + d) : !1 !== b.jsonp && (b.url += (kc.test(b.url) ? "&" : "?") + b.jsonp + "=" + d),
            ...
            k.always(function() {
                a[d] = n;
                b[d] && (b.jsonpCallback = c.jsonpCallback,
                Rc.push(d));
    ...
    f.fn.load = function(a, b, c) {
        if ("string" !== typeof a && Sc)
            return Sc.apply(this, arguments);
        var k, d, n, e = this, r = a.indexOf(" ");
        0 <= r && (k = a.slice(r, a.length),
        a = a.slice(0, r));
        f.isFunction(b) ? (c = b,
        b = void 0) : b && "object" === typeof b && (n = "POST");
        0 < e.length && f.ajax({
            url: a,
            type: n,
            dataType: "html",
    ...
    f.offset = {
        setOffset: function(a, b, c) {
            var k, d, n, e = f.css(a, "position"), r = f(a), j = {};
            "static" === e && (a.style.position = "relative");
            n = r.offset();
            d = f.css(a, "top");
            k = f.css(a, "left");
            ("absolute" === e || "fixed" === e) && -1 < f.inArray("auto", [d, k]) ? (k = r.position(),
            d = k.top,
            k = k.left) : (d = parseFloat(d) || 0,
            k = parseFloat(k) || 0);
    ...
    f.fn.extend({
        offset: function(a) {
            ...
            if (d) {
                ...
                if (!f.contains(b, c))
                    return k;
                typeof c.getBoundingClientRect !== ka && (k = c.getBoundingClientRect());
                c = ca(d);
                return {
        ...
        position: function() {
            if (this[0]) {
                ...
                "fixed" === f.css(k, "position") ? b = k.getBoundingClientRect() : (a = this.offsetParent(),
                b = this.offset(),
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var a = this.offsetParent || Tc; a && !f.nodeName(a, "html") && "static" === f.css(a, "position"); )
                    a = a.offsetParent;
                return a || Tc
            })
        }
    ...
    f.each({
        ...
        f.each({
            ...
            f.fn[k] = function(k, d) {
                ...
                return Ua(this, function(b, c, k) {
                    return f.isWindow(b) ? b.document.documentElement["client" + a] : 9 === b.nodeType ? (c = b.documentElement,
                    Math.max(b.body["scroll" + a], c["scroll" + a], b.body["offset" + a], c["offset" + a], c["client" + a])) : void 0 === k ? f.css(b, c, e) : f.style(b, c, k, e)
                }, b, n ? k : void 0, n, null)
            }
        })
    });
    ...
    a.support.iecors ? a.ajaxTransport(function(a) {
        return {
            send: function(h, e) {
                ...
                ;
                a.xhrFields && (j.onerror = a.xhrFields.error,
                ...
                h = function() {
                    ...
                    try {
                        if (h && 4 === t.readyState) {
                            h = void 0;
                            try {
                                e.text = "string" === typeof t.responseText ? t.responseText : null
                            } catch (m) {}
                            try {
                                e.binary = t.response
                            } catch (s) {}
...
(function(a, m) {
    ...
    a._fixProtocol = function(b) {
        ...
        return 0 == b.indexOf("http://www.rcsb.org/pdb/files/") && 0 > b.indexOf("/ligand/") ? "http://files.rcsb.org/view/" + b.substring(30).replace(/\.gz/, "") : 0 == b.indexOf("http://") && ("https://" == a._httpProto || 0 < b.indexOf(".gov/") || 0 == b.indexOf("http://www.materialsproject")) ? "https" + b.substring(4) : b
    }
    ;
    ...
    e.supportsWebGL = function() {
        if (!a.featureDetection._webGLtest) {
            var b;
            a.featureDetection._webGLtest = h.WebGLRenderingContext && ((b = l.createElement("canvas")).getContext("webgl") || b.getContext("experimental-webgl")) ? 1 : -1
        }
    ...
    e.supportsLocalization = function() {
        for (var a = l.getElementsByTagName("meta"), c = a.length; 0 <= --c; )
            if (0 <= a[c].outerHTML.toLowerCase().indexOf("utf-8"))
                return !0;
        return !1
    }
    ;
    e.supportsJava = function() {
        a.featureDetection._javaEnabled || (a.featureDetection._javaEnabled = a._isMsie ? navigator.javaEnabled() ? 1 : -1 : navigator.javaEnabled() && (!navigator.mimeTypes || navigator.mimeTypes["application/x-java-applet"]) ? 1 : -1);
    ...
    e.compliantBrowser = function() {
        var a = !!l.getElementById
          , c = e.os;
        if ("opera" == e.browserName && 7.54 >= e.browserVersion && "mac" == c || "webkit" == e.browserName && 125.12 > e.browserVersion || "msie" == e.browserName && "mac" == c || "konqueror" == e.browserName && 3.3 >= e.browserVersion)
            a = !1;
        return a
    }
    ;
    ...
    a._getGrabberOptions = function(b) {
        ...
        1 == a._grabberOptions.length ? (c = "<nobr>" + c + '<span style="display:none">',
        d = "</span>" + d) : c += "<br /><nobr>";
        for (var c = c + '<select id="ID_select">', e = 0; e < a._grabberOptions.length; e++)
        ...
        if (0 == d.indexOf("ERROR"))
            ...
            case "=":
                ...
                for (d = 1; d < c.length; d++)
                    e.push('<tr><td valign=top><a href="javascript:Jmol.search(' + a._id + ",'=" + c[d].substring(0, 4) + "')\">" + c[d].substring(0, 4) + "</a></td>"),
                    e.push("<td>" + c[d].split("Title>")[1].split("</")[0] + "</td></tr>");
                e.push("</table>");
    ...
    a._getDirectDatabaseCall = function(b, c) {
        if (c && !a.featureDetection.supportsXhr2())
            return b;
        var d = 2
          , e = b.substring(0, d)
          , j = a.db._DirectDatabaseCalls[e] || a.db._DirectDatabaseCalls[e = b.substring(0, --d)];
        j && (":" == e ? (e = b.toLowerCase(),
        isNaN(parseInt(b.substring(1))) ? 0 == e.indexOf(":smiles:") ? (j += "?POST?smiles=" + b.substring(8),
        b = "smiles") : 0 == e.indexOf(":cid:") ? b = "cid/" + b.substring(5) : (0 == e.indexOf(":name:") ? b = b.substring(5) : 0 == e.indexOf(":cas:") && (b = b.substring(4)),
        b = "name/" + encodeURIComponent(b.substring(d))) : b = "cid/" + b.substring(1)) : b = encodeURIComponent(b.substring(d)),
        0 <= b.indexOf(".mmtf") ? b = "https://mmtf.rcsb.org/v1.0/full/" + b.replace(/\.mmtf/, "") : 0 <= j.indexOf("FILENCI") ? (b = b.replace(/\%2F/g, "/"),
        b = j.replace(/\%FILENCI/, b)) : b = j.replace(/\%FILE/, b));
        return b
    }
    ;
    ...
    a._checkFileName = function(b, c, d) {
        a._isDatabaseCall(c) && (d && a._setQueryTerm(b, c),
        c = a._getDirectDatabaseCall(c, !0),
        a._isDatabaseCall(c) && (c = a._getDirectDatabaseCall(c, !1),
        d && (d[0] = !0)));
        return c
    }
    ;
    a._checkCache = function(b, c, d) {
        if (b._cacheFiles && a._fileCache && !c.endsWith(".js")) {
            if (b = a._fileCache[c])
                return System.out.println("using " + b.length + " bytes of cached data for " + c),
                d(b),
                null;
            d = function(b, c) {
                d(a._fileCache[b] = c)
    ...
    a._checkAjaxPost = function(a) {
        ...
        0 < c && (a.data = a.url.substring(c + 6),
    ...
    a._search = function(b, c, d) {
        ...
        a._setQueryTerm(b, c);
        c || (c = a.$val(a.$(b, "query")));
        0 == c.indexOf("!") ? b._script(c.substring(1)) : (c && (c = c.replace(/\"/g, "")),
        b._showInfo(!1),
    ...
    a._searchMol = function(b, c, d, e) {
        var j;
        a._isDatabaseCall(c) ? (j = c.substring(0, 1),
        c = c.substring(1)) : j = b._hasOptions ? a.$val(a.$(b, "select")) : "$";
        "=" == j && 3 == c.length && (c = "=" + c);
        var h = j + c;
        if (c && !(0 > h.indexOf("?") && h == b._thisJmolModel)) {
            ...
            e && null != b._viewSet && null != (l = a.View.__findView(b._viewSet, {
                chemID: h
            })) ? a.View.__setView(l, b, !1) : ("$" == j || ":" == j ? b._jmolFileType = "MOL" : "=" == j && (b._jmolFileType = "PDB"),
    ...
    a._searchDatabase = function(b, c, d, e) {
        b._showInfo(!1);
        return 0 <= c.indexOf("?") ? (a._getInfoFromDatabase(b, d, c.split("?")[0]),
        !0) : a.db._DirectDatabaseCalls[d] ? (b._loadFile(d + c, e),
        !0) : !1
    }
    ;
    a._syncBinaryOK = "?";
    a._canSyncBinary = function(b) {
        if (a._isAsync)
            return !0;
        if (self.VBArray)
            return a._syncBinaryOK = !1;
        if ("?" != a._syncBinaryOK)
            return a._syncBinaryOK;
        a._syncBinaryOK = !0;
        try {
            ...
            a._alertNoBinary && !b && alert("JSmolCore.js: synchronous binary file transfer is requested but not available"),
            a._syncBinaryOK = !1
        }
        return !0
    }
    ;
    a._binaryTypes = "mmtf .gz .bz2 .jpg .gif .png .zip .jmol .bin .smol .spartan .pmb .mrc .map .ccp4 .dn6 .delphi .omap .pse .dcd .lut .uk/pdbe/densities/".split(" ");
    a.isBinaryUrl = function(b) {
        for (var c = a._binaryTypes.length; 0 <= --c; )
            if (0 <= b.indexOf(a._binaryTypes[c]))
                return !0;
        return !1
    }
    ;
    a._getFileData = function(b, c, d) {
        ...
        var l = 0 > b.indexOf("://") || 0 == b.indexOf(document.location.protocol) && 0 <= b.indexOf(document.location.host)
          ...
          , m = a._isDirectCall(b);
        !m && 0 <= b.indexOf("?ALLOWSORIGIN?") && (m = !0,
        b = b.replace(/\?ALLOWSORIGIN\?/, ""));
        ...
        if (t || j || !l && !m || !c && s)
            ...
            O.data = b.split("?POST?")[1]) : (O.type = "GET",
            O.url = b);
            c && (O.success = function() {
    ...
    a._xhrReturn = function(a) {
        return !a.responseText && "" !== a.responseText || self.Clazz && Clazz.instanceOf(a.response, self.ArrayBuffer) ? a.response || a.statusText : a.responseText
    }
    ;
    a._isDirectCall = function(b) {
        if (0 <= b.indexOf("?ALLOWSORIGIN?"))
            return !0;
        for (var c in a.db._DirectDatabaseCalls)
            if (0 <= c.indexOf(".") && 0 <= b.indexOf(c))
                return !0;
        return !1
    }
    ;
    ...
    a.loadFileAsynchronously = function(b, c, d, e) {
        ...
        if (!a.featureDetection.hasFileReader)
            return b ? b.setData("Local file reading is not enabled in your browser", null, null, e, c) : alert("Local file reading is not enabled in your browser");
        ...
        a.$after("#" + c._id + "_appletdiv", h.replace(/ID/g, c._id + "_localReader")),
        ...
        a.$appEvent(c, "localReader_loadurl", "click", function() {
            ...
            b && (a._hideLocalFileReader(c, 0),
            a._setData(null, b, b, null, e, c))
        });
        ...
        a.$appEvent(c, "localReader_loadfile", "click", function() {
            ...
            j.onloadend = function(j) {
                j.target.readyState == FileReader.DONE && (a._hideLocalFileReader(c, 0),
    ...
    a._setData = function(b, c, d, e, j, h) {
        e && (e = a._strToBytes(e));
        null != e && (null == b || 0 <= c.indexOf(".jdx")) && a.Cache.put("cache://" + c, e);
    ...
    a._saveFile = function(b, c, d, e) {
        if (a._localFileSaveFunction && a._localFileSaveFunction(b, c))
            return "OK";
        ...
        a._useDataURI || !j ? (e = document.createElement("a"),
        ...
        m("body").append(e),
        e.click(),
        e.remove()) : (a._formdiv || (a.$after("body", '<div id="__jsmolformdiv__" style="display:none">\t\t\t\t\t\t<form id="__jsmolform__" method="post" target="_blank" action="">\t\t\t\t\t\t<input name="call" value="saveFile"/>\t\t\t\t\t\t<input id="__jsmolmimetype__" name="mimetype" value=""/>\t\t\t\t\t\t<input id="__jsmolencoding__" name="encoding" value=""/>\t\t\t\t\t\t<input id="__jsmolfilename__" name="filename" value=""/>\t\t\t\t\t\t<textarea id="__jsmoldata__" name="data"></textarea>\t\t\t\t\t\t</form>\t\t\t\t\t\t</div>'),
    ...
    a._getWrapper = function(b, c) {
        ...
        if (c) {
            var e = "";
            if (b._coverImage)
                var e = ' onclick="Jmol.coverApplet(ID, false)" title="' + b._coverTitle + '"'
                  , j = '<image id="ID_coverclickgo" src="' + b._makeLiveImage + '" style="width:25px;height:25px;position:absolute;bottom:10px;left:10px;z-index:' + a._getZ(b, "coverImage") + ';opacity:0.5;"' + e + " />"
            ...
            j = b._isJava ? "" : '<image id="ID_waitimage" src="' + b._j2sPath + '/img/cursor_wait.gif" style="display:none;position:absolute;bottom:10px;left:10px;z-index:' + a._getZ(b, "coverImage") + ';" />';
            ...
            d = '...<div id="ID_appletinfotablediv" style="width:Wpx;height:Hpx;position:relative;font-size:14px;text-align:left">IMG WAIT......<div id="ID_appletdiv" style="z-index:' + a._getZ(b, "header") + ";width:100%;height:100%;position:absolute;top:0px;left:0px;" + d + ">";
            var h = b._height
              , l = b._width;
    ...
    a._setObject = function(b, c, d) {
        ...
        null != b._viewSet && (a.View.__init(b),
        b._currentView = null);
    ...
    a._addDefaultInfo = function(b, c) {
        for (var d in c)
            "undefined" == typeof b[d] && (b[d] = c[d]);
        a._use && (b.use = a._use);
        0 <= b.use.indexOf("SIGNED") && (0 > b.jarFile.indexOf("Signed") && (b.jarFile = b.jarFile.replace(/Applet/, "AppletSigned")),
    ...
    a._setReady = function(b) {
        ...
        for (var c = 0, d = 0; d < a._syncedApplets.length; d++) {
            if (a._syncedApplets[d] == b._id)
                a._syncedApplets[d] = b,
                a._syncedReady[d] = 1;
            else if (!a._syncedReady[d])
                continue;
            c++
        }
    ...
    a._setSyncReady = function() {
        ...
        for (var b = "", c = 0; c < a._syncedApplets.length; c++)
            a._syncedCommands[c] && (b += "Jmol.script(Jmol._syncedApplets[" + c + "], Jmol._syncedCommands[" + c + "]);");
        setTimeout(b, 50)
    }
    ;
    a._mySyncCallback = function(b, c) {
        app = a._applets[b];
        if (app._viewSet)
            a.View.updateFromSync(app, c);
        else {
            if (!a._syncReady || !a._isJmolJSVSync)
                return 1;
            for (var d = 0; d < a._syncedApplets.length; d++)
                0 <= c.indexOf(a._syncedApplets[d]._syncKeyword) && a._syncedApplets[d]._syncScript(c);
            return 0
        }
    }
    ;
    ...
    a._sortMessages = function(a) {
        ...
        for (var d = [], e = a.length - 1; 0 <= e; e--)
            for (var j = 0, h = a[e].length; j < h; j++)
                d[d.length] = a[e][j];
        if (0 != d.length)
            return d = d.sort(c)
    }
    ...
    a._setMouseOwner = function(b, c) {
        null == b || c ? (a._mouseOwner = b) && b._applet && (a._lastAppletID = b._applet._id) : a._mouseOwner == b && (a._mouseOwner = null)
    }
    ;
    ...
    a._jsGetXY = function(b, c) {
        if (!b.applet._ready || a._touching && 0 > c.type.indexOf("touch"))
            return !1;
        var d = a.$offset(b.id), e, j = c.originalEvent;
        c.pageX || (c.pageX = j.pageX);
        c.pageY || (c.pageY = j.pageY);
        a._mousePageX = c.pageX;
        a._mousePageY = c.pageY;
        j.targetTouches && j.targetTouches[0] ? (e = j.targetTouches[0].pageX - d.left,
        d = j.targetTouches[0].pageY - d.top) : j.changedTouches ? (e = j.changedTouches[0].pageX - d.left,
        d = j.changedTouches[0].pageY - d.top) : (e = c.pageX - d.left,
        d = c.pageY - d.top);
    ...
    a._jsSetMouse = function(b) {
        ...
        a.$bind(b, "mousedown touchstart", function(d) {
            ...
            b.isDragging = !0;
            if ("touchstart" == d.type && a._gestureUpdate(b, d))
                return !!e;
            a._setConsoleDiv(b.applet._console);
            var j = a._jsGetXY(b, d);
            j && (2 != d.button && a.Swing.hideMenus(b.applet),
        ...
        a.$bind(b, "mouseup touchend", function(d) {
            ...
            b.isDragging = !1;
            if ("touchend" == d.type && a._gestureUpdate(b, d))
                return !!e;
        ...
        a._drag = function(b, c) {
            c.stopPropagation();
            c.preventDefault();
            if ("touchmove" == c.type && a._gestureUpdate(b, c))
                return !1;
        ...
        a.$bind(b, "mousemoveoutjsmol", function(d, e, j) {
            if (c(j))
                return !0;
            if (b == a._mouseOwner && b.isDragging)
                return a._drag(b, j)
        });
    ...
    a._jsUnsetMouse = function(b) {
        b.applet = null;
        a.$bind(b, "mousedown touchstart mousemove touchmove mouseup touchend DOMMouseScroll mousewheel contextmenu mouseout mouseenter", null);
        a._setMouseOwner(null)
    }
    ;
    a.Swing = {
    ...
    s.setDraggable = function(b) {
        ...
        b.setContainer || (b.setContainer = function(b) {
            ...
            b.bind("mousemove touchmove", function(b) {
                if (d.isDragging && a._mouseOwner == d)
                    return d.mouseMove(b),
                    !1
            });
        ...
        b.mouseUp = function(b) {
            if (this.isDragging && a._mouseOwner == this)
                return this.pageX0 += b.pageX - this.pageX,
    ...
    s.setDialog = function(b) {
        a._setMouseOwner(null);
        a.$remove(b.id);
        var c = b.id + "_mover", d = a._$(c), e;
        d[0] ? (d.html(b.html),
        e = d[0].jd) : (a.$after("body", "<div id='" + c + "' style='position:absolute;left:0px;top:0px;'>" + b.html + "</div>"),
        e = new s.JSDialog,
        d = a._$(c),
        b.container = d,
    ...
    s.click = function(b, c) {
        ...
        if (d) {
            var e = d.toString();
            if (0 <= e.indexOf("JCheck"))
                d.selected = b.checked;
            else if (0 <= e.indexOf("JCombo"))
                d.selectedIndex = b.selectedIndex;
            else if (null != d.text && (d.text = b.value,
    ...
    a.getProfile = function(a) {
        if (self.Clazz && self.JSON)
            return u || Clazz._startProfiling(u = 0 == arguments.length || a),
            Clazz.getProfile()
    }
    ;
    ...
    (function(b) {
        ...
        b.updateView = function(c, d) {
            if (null != c._viewSet) {
                ...
                if (null == (c._currentView = b.__findView(c._viewSet, d)))
                    c._currentView = b.__createViewSet(c._viewSet, d.chemID, d.viewID || d.chemID);
        ...
        b.__findView = function(a, d) {
            ...
            for (var j = e.length; 0 <= --j; ) {
                var h = e[j];
                if (d.viewID) {
                    if (h.info.viewID == d.viewID)
                        return h
                } else {
                    if (null != d.chemID && d.chemID == h.info.chemID)
                        return h;
                    for (var l in h)
                        if ("info" != l && (null != d.data && null != h[l].data ? d.data == h[l].data : d.type == l))
                            return h
                }
            }
            return null
        ...
        a.$appEvent(b, c, "drop", function(d) {
            ...
            if (null == j)
                try {
                    ...
                    (0 == j.indexOf("file:/") || 0 == j.indexOf("http:/") || 0 == j.indexOf("https:/")) && b._scriptLoad(j)
                } catch (h) {}
            else
                e = new FileReader,
                e.onloadend = function(e) {
                    if (e.target.readyState == FileReader.DONE) {
                        ...
                        if ("console_input" == c)
                            ...
                            a.$(b, c).val(0 > h.indexOf("\x00") ? h : e.length + " bytes");
                        else {
                            h.endsWith(".spt") || b._appletPanel.cacheFileByName("cache://DROP_*", !1);
                            "JSV" == b._viewType || h.endsWith(".jdx") ? a.Cache.put(h, e) : b._appletPanel.cachePut(h, e);
                            e = a._jsGetXY(b._canvas, d);
                            var l = [null];
                            e && (!b._appletPanel.setStatusDragDropped || b._appletPanel.setStatusDragDropped(0, e[0], e[1], h, l)) && b._appletPanel.openFileAsyncSpecialType(h, 1, l[0])
                        }
                    }
                }
                ,
...
(function(a) {
    ...
    var m = !1
      ...
      , s = function(b) {
        ...
        delete e;
        for (var d; 0 < h.length && "done" == (d = h[0])[4]; )
            h.shift();
        if (0 != h.length)
            if (!a._isAsync && !b)
                setTimeout(s, 10);
      ...
      , u = function(b) {
        m ? s() : (m = !0,
        LoadClazz(),
        b._noMonitor && (Clazz._LoaderProgressMonitor.showStatus = function() {}
        ),
        LoadClazz = null,
        ...
        if (!(0 <= j.join("").indexOf(b))) {
            ...
            if (e && (e = e.split(" ")))
                for (b = 0; b < e.length; b++)
                    0 > t.join("").indexOf(e[b]) && t.push(d + "/core/core" + e[b] + ".z.js");
            for (b = 0; b < t.length; b++)
                a._coreFiles.push(t[b])
        }
    }
    ;
    a._Canvas2D = function(b, d, e, j) {
        ...
        if (!a._document || this._deferApplet)
            return this;
        this._init();
        return this
    }
    ...
    a._setAppletParams = function(b, d, e, j) {
        for (var h in e)
            if (!b || 0 <= b.indexOf(";" + h.toLowerCase() + ";"))
                null == e[h] || "language" == h && !a.featureDetection.supportsLocalization() || (j ? d.put(h, !0 === e[h] ? Boolean.TRUE : !1 === e[h] ? Boolean.FALSE : e[h]) : d[h] = e[h])
    }
    ;
    a._jsSetPrototype = function(b) {
        ...
        b._createCanvas = function(b, c, e) {
            ...
            this._deferApplet || (a._document ? (a._documentWrite(e),
            this._newCanvas(!1),
            e = "") : (this._deferApplet = !0,
            e += "<img width=0 height=0 src=. onerror=" + b + "._cover(false) >"));
        ...
        b._createCanvas2d = function() {
            ...
            try {
                ...
                this._canvas.contentLayer && b[0].removeChild(this._canvas.contentLayer),
            ...
            if (this._isLayered) {
                ...
                this._isSwing ? (b = document.createElement("div"),
                ...
                h.contentLayer.applet = this) : this._mouseInterface = this._getLayer("front", b, e, j, !1)
            } else
                this._mouseInterface = h;
    ...
    a.repaint = function(b, e) {
        if (b && b._appletPanel) {
            ...
            if (b._is2D && (b._canvas.width != h || b._canvas.height != j))
                b._newCanvas(!0),
                b._appletPanel.setDisplay(b._canvas);
    ...
    a.loadImage = function(b, e, j, h, l, t) {
        ...
        if (null == s) {
            ...
            System.out.println("Jsmol.js Jmol.loadImage reading cached image for " + m);
...
(function(a, m) {
    a._Applet = function(e, j, h) {
        ...
        this._initialize = function(e, h) {
            ...
            if (this._jarFile) {
                ...
                "yes" == prompt("Do you want to use applet " + c + "? ", "yes or no") ? (e = c.substring(0, c.lastIndexOf("/")),
                h = c.substring(c.lastIndexOf("/") + 1)) : b = !0) : h = c;
    ...
    l._getCanvas = function(e, j, h, m) {
        ...
        return m && a.featureDetection.supportsWebGL() ? (a._Canvas3D.prototype = a.GLmol.extendApplet(a._jsSetPrototype(new l(e,j,!0))),
        new a._Canvas3D(e,j,"Jmol",h)) : !m ? (a._Canvas2D.prototype = a._jsSetPrototype(new l(e,j,!0)),
        new a._Canvas2D(e,j,"Jmol",h)) : null
    }
    ;
    ...
    h._newApplet = function(a) {
        this._is2D || a.put("script", (a.get("script") || "") + ";set multipleBondSpacing 0.35;");
        this._viewerOptions = a;
        return new J.appletjs.Jmol(a)
    }
    ;
    h._addCoreFiles = function() {
        a._addCoreFile("jmol" + (a._debugCode ? "debug" : ""), this._j2sPath, this.__Info.preloadCore);
        a._debugCode && a._addCoreFile("jmoldebug", this._j2sPath, this.__Info.preloadCore);
    ...
    h._create = function(e, j) {
        ...
        var m;
        j.inlineModel ? (m = j.inlineModel,
        m = m.replace(/\r|\n|\r\n/g, 0 <= m.indexOf("|") ? "\\/n" : "|").replace(/'/g, "&#39;"),
    ...
    h._clearConsole = function() {
        ...
        self.Clazz && (a._setConsoleDiv(this._console),
        Clazz.Console.clear())
    }
    ;
    ...
    h._scriptWait = function(a, j) {
        ...
        if (!j)
            for (var m = h.length; 0 <= --m; )
                for (var b = 0, c = h[m].length; b < c; b++)
                    l += h[m][b] + "\n";
        return l
    }
    ;
    ...
    h._resizeApplet = function(e) {
        function h(e, j) {
            var b = "" + e;
            return 0 == b.length ? j ? "" : a._allowedJmolSize[2] : b.indexOf("%") == b.length - 1 ? b : 1 >= (e = parseFloat(e)) && 0 < e ? 100 * e + "%" : (isNaN(e = Math.floor(e)) ? a._allowedJmolSize[2] : e < a._allowedJmolSize[0] ? a._allowedJmolSize[0] : e > a._allowedJmolSize[1] ? a._allowedJmolSize[1] : e) + (j ? j : "")
        }
        var l;
        "object" == typeof e && null != e ? (l = e[0] || e.width,
        e = e[1] || e.height) : l = e;
        l = [h(l, "px"), h(e, "px")];
    ...
    h._searchDatabase = function(e, h, l) {
        if (this._2dapplet && this._2dapplet._isEmbedded && !a.$(this, "appletdiv:visible")[0])
            return this._2dapplet._searchDatabase(e, h, l);
        this._showInfo(!1);
        0 <= e.indexOf("?") ? a._getInfoFromDatabase(this, h, e.split("?")[0]) : (l || (l = a._getScriptForDatabase(h)),
        e = h + e,
    ...
    h.__loadModel = function(e, h, l) {
        null != e && (null != this._viewSet && (h || (h = ""),
        h += ";if ({*}.molecule.max > 1 || {*}.modelindex.max > 0){ delete molecule > 1 or modelindex > 0;x = getProperty('extractModel',{*});load inline @x};"),
        !h && this._noscript ? this._applet.loadInlineString(e, "", !1) : this._loadMolData(e, h, !1),
        null != this._viewSet && a.View.updateView(this, {
            chemID: l,
            data: e
        }))
    }
    ...
    h._checkDeferred = function(a) {
        return this._isDeferred() ? (this._coverScript = a,
        this._cover(!1),
        !0) : !1
    }
    ;
...
(function(a) {
    ...
    m._radio = function(a, h, e, j, t, s, u, b) {
        ...
        0 <= e.toLowerCase().indexOf("<td>") && (h += a,
        a = "");
    ...
    m._scriptExecute = function(l, h) {
        ...
        if ("object" == typeof j)
            ...
            "function" == typeof j ? j(e) : a.script(e, j)
    }
    ;
    ...
    m._commandKeyPress = function(l, h, e) {
        ...
        case 13:
            ...
            j._cmdpt = -1,
            j._cmdadd = 0),
            h && 0 == j._cmdadd ? (++j._cmdpt,
            j._cmds.splice(j._cmdpt, 0, h),
            j._cmdadd = 0,
            j._cmddir = 0) : j._cmdadd = 0,
            j.value = "",
            !1;
        case 27:
    ...
    m._cbNotifyMaster = function(a) {
        ...
        t.indeterminate = j;
        (a = m._checkboxItems[t.id]) && (t = a.chkMaster) && m._cbNotifyMaster(m._checkboxMasters[t.id])
    }
    ;
    m._cbNotifyGroup = function(a, h) {
        for (var e in a.chkGroup) {
            var j = a.chkGroup[e];
            j.checked != h && (j.checked = h,
            m._cbClick(j));
    ...
    m._cbSetCheckboxGroup = function(a, h, e) {
        ...
        for (a = j; a < h.length; a++)
            j = h[a],
            "number" == typeof j && (j = "jmolCheckbox" + j),
            (e = document.getElementById(j)) || alert("jmolSetCheckboxGroup: group checkbox not found: " + j),
            t.chkGroup[j] = e,
    ...
    m._onloadResetForms = function() {
        m._hasResetForms || (m._hasResetForms = !0,
        ...
        window.onload = function() {
            if (0 < m._buttonCount + m._checkboxCount + m._menuCount + m._radioCount + m._radioGroupCount)
                for (var a = document.forms, h = a.length; 0 <= --h; )
                    a[h].reset();
    ...
    m._getButton = function(l, h, e, j, t) {
        ...
        h = '<span id="span_' + j + '"' + (t ? ' title="' + t + '"' : "") + "><input type='button' name='" + j + "' id='" + j + "' value='" + e + "' onclick='Jmol.controls._click(this)' onmouseover='Jmol.controls._mouseOver(this);return true' onmouseout='Jmol.controls._mouseOut()' " + m._buttonCssText + " /></span>";
    ...
    m._getCheckbox = function(l, h, e, j, t, s, u) {
        ...
        else if (void 0 == j || null == j)
            alert("jmolCheckbox requires a label");
        else
            return m._actions[s] = [m._addScript(b, h), m._addScript(b, e)],
            l = "</span>",
            t = '<span id="span_' + s + '"' + (u ? ' title="' + u + '"' : "") + "><input type='checkbox' name='" + s + "' id='" + s + "' onclick='Jmol.controls._cbClick(this)' onmouseover='Jmol.controls._cbOver(this);return true' onmouseout='Jmol.controls._mouseOut()' " + (t ? "checked='true' " : "") + m._checkboxCssText + " />",
            0 <= j.toLowerCase().indexOf("<td>") && (t += l,
            l = ""),
        ...
        if (null != s && "object" == s && h.length) {
            ...
            for (j = 0; j < u; ++j) {
                ...
                if (null == s)
                    return "";
                null == t && (t = c);
                "#optgroup" == c ? e += "<optgroup label='" + t + "'>" : "#optgroupEnd" == c ? e += "</optgroup>" : (s = m._addScript(s, c),
                e += "<option value='" + s + (d ? "' selected='true'>" : "'>") + t + "</option>")
            }
            e += "</select></span>";
            a._debugAlert && alert(e);
            return a._documentWrite(e)
        ...
        if ("object" != u || null == u || !h.length)
            ...
            for (var c = "<span id='" + (t ? t : j) + "'>", d = 0; d < b; ++d) {
                ...
                var q = h[d]
                  , u = typeof q
                  , K = null
                  , c = "object" == u ? c + (K = m._radio(l, q[0], q[1], q[2], e, j, 3 < q.length ? q[3] : (t ? t : j) + "_" + d, 4 < q.length ? q[4] : 0, s)) : c + (K = m._radio(l, q, null, null, e, j, (t ? t : j) + "_" + d, s));
                if (null == K)
                    return ""
            }
            c += "</span>";
...
(function(a) {
    ...
    a.setXHTML = function(l) {
        ...
        a._XhtmlAppendChild = !1;
        l && (a._XhtmlElement = document.getElementById(l),
    ...
    a.setAppletHtml = function(l, h) {
        l._code && (a.$html(h, l._code),
        l._init && !l._deferApplet && l._init())
    }
    ;
...
LoadClazz = function() {
    TypeError.prototype.printStackTrace = ReferenceError.prototype.printStackTrace = function() {
        console.log(this)
    }
    ;
    c$ = null;
    ...
    function(a, m) {
        ...
        ;
        a.clone = function(a) {
            var b = a instanceof Array ? Array(a.length) : new a.constructor, c;
            for (c in a)
                b[c] = a[c];
            return b
        }
        ...
        a.getClassName = function(b, c) {
            ...
            case "function":
                if (b.__CLASS_NAME__)
                    return c ? b.__CLASS_NAME__ : "Class";
                var d = b.toString()
                  , e = d.indexOf("function");
                if (0 > e)
                    return "[" == d.charAt(0) ? a.extractClassName(d) : d.replace(/[^a-zA-Z0-9]/g, "");
                var e = e + 8
                  , h = d.indexOf("(", e);
                if (0 > h)
                    break;
                d = d.substring(e, h);
                if (0 <= d.indexOf("Array"))
                    return "Array";
                d = d.replace(/^\s+/, "").replace(/\s+$/, "");
                return "anonymous" == d || "" == d ? "Function" : d;
            case "object":
                if (b.__CLASS_NAME__)
                    return b.__CLASS_NAME__;
                if (!b.constructor)
                    break;
                if (!b.constructor.__CLASS_NAME__) {
                    ...
                    if (b instanceof Boolean)
                        return "Boolean";
                    if (b instanceof Array || b.BYTES_PER_ELEMENT)
                        return "Array";
                    d = b.toString();
                    if ("[" == d.charAt(0))
                        return a.extractClassName(d)
                }
        ...
        a.inheritClass = function(b, c, d) {
            for (var e in c)
                "b$" != e && ("prototype" != e && "superClazz" != e && "__CLASS_NAME__" != e && "implementz" != e && !t(c, e)) && (b[e] = c[e]);
            a.unloadedClasses[a.getClassName(b, !0)] || (b.prototype = d ? d : c !== Number ? new c(a.inheritArgs) : new Number);
            b.superClazz = c;
        ...
        var u = function(a, b) {
            for (var c in b)
                if ("b$" != c && "prototype" != c && "superClazz" != c && "__CLASS_NAME__" != c && "implementz" != c && ("function" != typeof b[c] || !t(b, c)))
        ...
        a.getInheritedLevel = function(b, c) {
            ...
            if (d && ("void" == b || "unknown" == b))
                return -1;
            var e = "string" == typeof c;
            if (e && ("void" == c || "unknown" == c))
                return -1;
            ...
            for (e = b; e !== c && 10 > d; ) {
                ...
                e = e.superClazz;
                if (!e)
                    return c === Object || c === a._O ? d + 1.5 : -1;
                d++
            }
            return d
        }
        ...
        a.superCall = function(b, c, d, e) {
            ...
            if (l)
                if (l.claxxOwner)
                    l.claxxOwner !== c && (h = l);
                else if (!l.stacks && (!l.lastClaxxRef || !l.lastClaxxRef.prototype[d] || !l.lastClaxxRef.prototype[d].stacks))
                    h = l;
                else {
                    var m = l.stacks;
            ...
            if (h)
                return 0 == j && "construct" == d && (c = l.stacks) && (!c[0].superClazz && c[0].con$truct) && c[0].con$truct.apply(b, []),
                h.apply(b, e || []);
            "construct" != d && (a.alert(["j2slib", "no class found", e.typeString]),
        ...
        a.defineMethod = function(c, d, h, j) {
                                ...
                                if (r || j[l] === d) {
                                    ...
                                    if (!(E = 0 == q.length)) {
                                        ...
                                        for (var E = [], N = q.length, u = 0; u < N; u++) {
                                            for (var x = [], xa = !0, C = q[u].length, B = 0; B < C; B++)
                                                if (x[B] = a.getInheritedLevel(z[B], q[u][B]),
                                                0 > x[B]) {
                                                    xa = !1;
                                                    break
                                                }
            ...
            q = m.stacks;
            0 > rb(q, c) && q.push(c);
            s && (s.claxxOwner === c ? (m[s.funParams] = s,
            s.claxxOwner = null,
            s.funParams = null) : s.claxxOwner || (m["\\unknown"] = s));
            h.exClazz = c;
            m[j] = h;
            return m
        }
        ...
        var C = function(b, c, d) {
            ...
            if (e && (e.claxxOwner || e.claxxReference) === b)
                ...
                (b = duplicatedMethods[key]) ? (c = "Warning! Duplicate method found for " + key,
                System.out.println(c),
                a.alert(c),
                duplicatedMethods[key] = b + 1) : duplicatedMethods[key] = 1
        };
        a.showDuplicates = function(a) {
            var b = "", c = duplicatedMethods, d = 0, e;
            for (e in c)
                1 < c[e] && (b += c[e] + "\t" + e + "\n",
                d++);
            b = "Duplicates: " + d + "\n\n" + b;
        ...
        a.declarePackage = function(b) {
            if (a.lastPackageName == b)
                return a.lastPackage;
            if (b && b.length) {
                for (var c = b.split(/\./), d = a.allPackage, e = 0; e < c.length; e++)
                    d[c[e]] || (d[c[e]] = {
        ...
        ;
        var Da = !1;
        -1 != navigator.userAgent.indexOf("Safari") && (j = navigator.userAgent,
        q = j.indexOf("Version/"),
        -1 != q && (j = j.substring(q + 8),
        Da = 4 <= parseFloat(j)));
        a.instantialize = function(a, b) {
            if (!b || !(1 == b.length && b[0] && b[0]instanceof s)) {
                a instanceof Number && (a.valueOf = function() {
                    return this
                }
                );
                if (Da) {
                ...
                (c = a.construct) ? a.con$truct ? a.getClass().superClazz ? c.claxxOwner && c.claxxOwner === a.getClass() || c.stacks && c.stacks[c.stacks.length - 1] == a.getClass() ? c.apply(a, b) : (c.claxxOwner && !c.claxxOwner.superClazz && c.claxxOwner.con$truct ? c.claxxOwner.con$truct.apply(a, []) : c.stacks && (1 == c.stacks.length && !c.stacks[0].superClazz) && c.stacks[0].con$truct.apply(a, []),
                c.apply(a, b),
                a.con$truct.apply(a, [])) : (a.con$truct.apply(a, []),
                c.apply(a, b)) : c.apply(a, b) : a.con$truct && a.con$truct.apply(a, [])
            }
        }
        ;
        ...
        a._innerFunctions = {
            ...
            getResourceAsStream: function(b) {
                ...
                if (0 == b.indexOf("/"))
                    if (2 == arguments.length ? (c = arguments[1]) || (c = a.binaryFolders[0]) : a._Loader && (c = a._Loader.getClasspathFor(d, !0)),
                    c) {
                        var c = c.replace(/\\/g, "/")
                          , e = c.length
                          , e = c.charAt(e - 1);
                    ...
                    if (this.base)
                        ...
                        if (c = a._Loader.getClasspathFor(d),
                        e = c.lastIndexOf(d.replace(/\./g, "/")),
                        -1 != e)
                            c = c.substring(0, e);
                        else if (e = -1,
                        c.indexOf(".z.js") == c.length - 5 && -1 != (e = c.lastIndexOf("/")))
                            for (var c = c.substring(0, e + 1), e = d.split(/\./), h = 1; h < e.length; h++) {
                                for (var j = "/", l = 0; l < h; l++)
                                    j += e[l] + "/";
                            ...
                            c = a._Loader.getClasspathFor(d, !0);
                    else
                        (e = a.binaryFolders) && e.length && (c = e[0]);
                    c || (c = "j2s/");
                    c = c.replace(/\\/g, "/");
                    e = c.length;
                    e = c.charAt(e - 1);
                    "/" != e && (c += "/");
                    this.base ? d = c + b : (e = d.lastIndexOf("."),
                    d = -1 == e || this.base ? c + b : c + d.substring(0, e).replace(/\./g, "/") + "/" + b)
                }
                c = null;
                try {
                    if (0 > d.indexOf(":/")) {
                ...
                if (!q || "error" == q || 0 == q.indexOf("[Exception"))
                    return null;
        ...
        a.decorateAsClass = function(b, c, d, e, h, j) {
            var l = null;
            c && (l = c.__PKG_NAME__,
            l || (l = c.__CLASS_NAME__));
            var m = (l ? l + "." : "") + d;
            a._Loader._classPending[m] && (delete a._Loader._classPending[m],
        ...
        var db = function(b, c, d) {
            var e;
            c ? c.__PKG_NAME__ ? (e = c.__PKG_NAME__ + "." + d,
            c[d] = b,
            c === java.lang && a.setGlobal(d, b)) : (e = c.__CLASS_NAME__ + "." + d,
            c[d] = b) : (e = d,
            a.setGlobal(d, b));
            a.extendJO(b, e);
            c = a.innerFunctionNames;
            for (d = 0; d < c.length; d++)
                b[c[d]] = a._innerFunctions[c[d]];
        ...
        a.decorateAsType = function(b, c, d, e, h, j) {
            ...
            if (j)
                for (c = 0; c < a.innerFunctionNames.length; c++)
                    j = a.innerFunctionNames[c],
                    b[j] = a._innerFunctions[j];
        ...
        var la = function(a, b) {
            ...
            switch (b) {
            case 8:
                return d = new Int8Array(c),
                d.BYTES_PER_ELEMENT = 1,
                d;
            case 32:
                return d = new Int32Array(c),
                d.BYTES_PER_ELEMENT = 4,
                d;
            case 64:
                return d = new Float64Array(c),
        ...
        !0 == (a.haveInt8 = !!self.Int8Array) ? (Int8Array.prototype.sort || (Int8Array.prototype.sort = Array.prototype.sort),
        Int8Array.prototype.slice || (Int8Array.prototype.slice = function() {
            return ta.apply(this, arguments)
        }
        ...
        java.lang.System = System = {
            ...
            getProperty: function(a, b) {
                if (System.props)
                    return System.props.getProperty(a, b);
        ...
        a._innerFunctions.getDeclaredMethods = a._innerFunctions.getMethods = function() {
            var a = [], b = this.prototype, c;
            for (c in b)
                "function" == typeof b[c] && !b[c].__CLASS_NAME__ && a.push(new java.lang.reflect.Method(this,c,[],java.lang.Void,[],java.lang.reflect.Modifier.PUBLIC));
            b = this;
            for (c in b)
                "function" == typeof b[c] && !b[c].__CLASS_NAME__ && a.push(new java.lang.reflect.Method(this,c,[],java.lang.Void,[],java.lang.reflect.Modifier.PUBLIC | java.lang.reflect.Modifier.STATIC));
            return a
        }
        ;
        ...
        a._innerFunctions.newInstance = function(a) {
            ...
            default:
                for (var b = "new " + this.__CLASS_NAME__ + "(", c = 0; c < a.length; c++)
                    b += (0 == c ? "" : ",") + "a[" + c + "]";
                return eval(b + ")")
            }
        }
        ...
        (function(a, b) {
            ...
            b.updateNodeForFunctionDecoration = function(a) {
                (a = G(a)) && a.status == x.STATUS_KNOWN && window.setTimeout(function(a) {
                    return function() {
                        updateNode(a)
                    }
                }(a), 1)
            ...
            var B;
            self.Clazz && a.isClassDefined ? isClassDefined = a.isClassDefined : (B = {},
            ...
            b.loadPackageClasspath = function(a, c, d, e, f, h) {
                ...
                if (a instanceof Array)
                    if (C(a),
                    e)
                        h < a.length ? b.loadPackageClasspath(a[h], c, d, function() {
                    ...
                    c && (D["@" + a] = c);
                    d && !j && !window[a + ".registered"] ? (K++,
                    "java" == a && (a = "core"),
                    b.loadClass(a + ".package", function() {
                        0 == --K && da()
                    }, !0, !0, 1)) : e && e()
                }
            }
            ...
            b.loadClass = function(c, f, h, j, l) {
                ...
                b.keepOnLoading = !0;
                if (!h && (K && c.lastIndexOf(".package") != c.length - 8 || 0 != c.indexOf("java.") && !isClassDefined(ea)))
                    Ja.push([c, f]),
                    System.out.println("loadclass-queuing" + c + ea + " " + isClassDefined(ea));
                else if ((l = isClassDefined(c)) || L["@" + c]) {
                    if (l && f && (h = G(c),
                    !h || h.status >= x.STATUS_LOAD_COMPLETE))
                    ...
                    if (l) {
                        ...
                        if (!c) {
                            ...
                            h && (f = null);
                            Ha(d, l, !0);
                            W(l, l.path, l.requiredBy, !1, f ? function() {
                                ha = s;
                                f()
                            }
                            : null)
            ...
            b.registerPackages = function(c, d) {
                for (var e = b.getClasspathFor(c + ".*", !0), f = 0; f < d.length; f++)
            ...
            b.getClasspathFor = function(c, d, e) {
                ...
                if (!f || d || e) {
                    ...
                    if (f) {
                        if (c = c.replace(/\./g, "/"),
                        0 <= (j = f.lastIndexOf(c)) || 0 <= (j = c.lastIndexOf("/")) && 0 <= (j = f.lastIndexOf(c.substring(0, j))))
                            h = f.substring(0, j)
                    } else {
            ...
            var W = function(c, d, f, j, l) {
              ...
              , ca = function(c, d, e) {
                a.getStackTrace();
                return function() {
                    f && this.timeoutHandle && (window.clearTimeout(this.timeoutHandle),
                    ...
                    ;
                    0 <= Y ? window.setTimeout(function() {
                        sa(c, j)
                    }, Y) : sa(c, j)
                }
            }
                ...
                if (l) {
                    ...
                    if (r)
                        for (var q = 0; q < r.length; q++) {
                            var t = r[q];
                            if (t != l.name && (m = G(t)))
                                m.status < x.STATUS_CONTENT_LOADED && (m.status = x.STATUS_CONTENT_LOADED,
                                updateNode(m));
                            else {
                                m = new x;
                                m.name = t;
                    ...
                    if (l instanceof Array)
                        for (q = 0; q < l.length; q++)
                            l[q].status < x.STATUS_CONTENT_LOADED && (l[q].status = x.STATUS_CONTENT_LOADED,
                            updateNode(l[q]));
                        ...
                        m || (l.status = x.STATUS_CONTENT_LOADED,
                        updateNode(l))
                    }
                    if (b.keepOnLoading) {
                        q = !0;
                        if (m = Ia(x.STATUS_KNOWN))
                            for (Q(m); h < j && (m = Ia(x.STATUS_KNOWN)); )
                                Q(m);
                        else if (0 != H.length)
                            m = H.shift(),
                            !e[m.path] || 0 != H.length || !ha || m.musts.length || m.optionals.length ? (Ha(d, m, !0),
                            W(m, m.path, m.requiredBy, !1)) : ha && (ha = !1);
                        else if (m = F(x.STATUS_KNOWN))
                            for (Q(m); h < j && (m = F(x.STATUS_KNOWN)); )
                                Q(m);
                        else
                            q = !1;
                        if (!(q || 0 < h)) {
                            ...
                            if (f)
                                ...
                                b._checkLoad && (System.out.println("I think I'm done: SAEM call count: " + O),
                                a.showDuplicates(!0));
                            b.onGlobalLoaded()
                        }
                    }
              ...
              , ma = function(a, c) {
                ...
                if (0 <= f) {
                    ...
                    for (; f < e; f++) {
                        ...
                        Ba(j);
                        for (h = 0; h < j.parents.length; h++)
                            updateNode(j.parents[h]);
                        j.parents = [];
                        var k = j.onLoaded;
                        b._checkLoad && (h = "cycle setting status to LOAD_COMPLETE for " + j.name + (k ? " firing " + k.toString() : ""),
                ...
                for (h = 0; 2 > h; h++) {
                    k = j[h];
                    for (f = k.length; 0 <= --f; )
                        if (k[f].status == x.STATUS_DECLARED && ma(k[f], c))
                            return !0
                }
                d.length = e;
                return !1
            ...
            b.showPending = function() {
                ...
                for (c in b._classPending) {
                    var d = G(c);
                    d ? (a.push(d),
                    System.out.println(ta("", "", d, "", 0))) : alert("No node for " + c)
                }
                return a
            }
            ;
            ...
            updateNode = function(a) {
                if (!a.name || a.status >= x.STATUS_LOAD_COMPLETE)
                    Ba(a);
                else {
                    var c = !0;
                    if (a.musts.length && a.declaration)
                        for (var d = a.musts.length, e = d; 0 <= --e; ) {
                            ...
                            if (f.status < x.STATUS_DECLARED && isClassDefined(f.name)) {
                                ...
                                if (f.declaration && f.declaration.clazzList) {
                                    for (var j = 0, k = f.declaration.clazzList, l = k.length; j < l; j++) {
                                        var m = G(k[j]);
                                        m && (m.status != x.STATUS_LOAD_COMPLETE && m !== f) && (m.status = f.status,
                                        m.declaration = null,
                                        Ba(m),
                                        m.onLoaded && h.push(m))
                                    }
                            ...
                            a.musts.length != d && (e = d = a.musts.length,
                            c = !0)
                        }
                    if (c) {
                        if (a.status < x.STATUS_DECLARED) {
                            if (e = a.declaration)
                                e(),
                                e.executed = !0;
                            b._checkLoad && b._classPending[a.name] && (delete b._classPending[a.name],
                            b._classCountOK,
                            ...
                            if (a.declaration && a.declaration.clazzList) {
                                ...
                                for (l = k.length; j < l; j++)
                                    if ((m = G(k[j])) && m.status != x.STATUS_DECLARED && m !== a)
                        ...
                        c = x.STATUS_DECLARED;
                        if (0 == a.optionals.length && 0 == a.musts.length || a.status > x.STATUS_KNOWN && !a.declaration || Sa(a.musts, x.STATUS_LOAD_COMPLETE) && Sa(a.optionals, x.STATUS_LOAD_COMPLETE)) {
                        ...
                        if (a.parents && a.parents.length) {
                            for (e = 0; e < a.parents.length; e++)
                                j = a.parents[e],
                                j.status < c && updateNode(j, j.name);
            ...
            var Sa = function(a, b) {
              ...
              , $a = function(a, b) {
                for (var c = d.random, e = b.length; 0 <= --e; ) {
                    var f = b[e];
                    if (f.name == a || f.random != c && (f.random = c,
                    f = Ca(a, f)))
                        return f
                }
                return null
              ...
              , Aa = function(a, b) {
                var c;
                return (c = na(a.musts, b)) || (c = na(a.optionals, b)) || ya(c = a, b) ? c : null
            }
              , na = function(a, b) {
                if (a)
                    for (var c = d.random, e = 0; e < a.length; e++) {
                        var f = a[e];
                        if (ya(f, b) || f.random != c && (f.random = c,
                        f = Aa(f, b)))
                            return f
                    }
                return null
              ...
              , P = function(a, c, e, f) {
                if (c instanceof Array) {
                    ...
                    b._checkLoad && !b._classPending[c] && (b._classPending[c] = 1,
                    ...
                    Ha(d, h, !1));
                    ia(h, a, !0);
                    5 == arguments.length && f && (f.status = h.status,
                    f.clazzList = arguments[4]);
                    if (h.declaration = f)
                        h.status = x.STATUS_CONTENT_LOADED;
                    ia(h, e, !1)
                }
            }
              , ia = function(a, b, c) {
            ...
            b.setLoadingMode = function(a, c) {
                ...
                d = !1) : a & b.MODE_SCRIPT ? e = !1 : d = !(a & b.MODE_SYNC);
                I = e;
                Y = (ra = d) && 0 <= c ? c : -1;
                return d
            }
            ...
            var Da = {}
              ...
              , Ha = function(a, b, c) {
                var e = !1;
                c ? (c = a.musts,
                b.requiredBy || (b.requiredBy = a)) : c = a.optionals;
                Da[b.name] || (Na.push(b),
                Da[b.name] = b);
                ...
                e || (c.push(b),
                ha && (0 != b.name.indexOf("java") && 0 != b.name.indexOf("net.sf.j2s.ajax")) && (ga && (ha = !1),
                ga = !0));
                a: {
                    if (a.name && a != d && a != b)
                        for (e = 0; e < b.parents.length; e++)
                            if (b.parents[e].name == a.name)
                                break a;
                    b.parents.push(a)
                }
            }
        ...
        var W = a._LoaderProgressMonitor
          ...
          , L = null
          , ua = 0;
        W.DEFAULT_OPACITY = m && m._j2sLoadMonitorOpacity ? m._j2sLoadMonitorOpacity : 55;
        ...
        var jb = function(a) {
          ...
          , kb = function(a) {
            H && a == W.DEFAULT_OPACITY && (window.clearTimeout(H),
            H = null);
            ga = a;
          ...
          , wa = !1
          , ma = function() {
            "none" != L.style.display && (ga == W.DEFAULT_OPACITY ? (H = window.setTimeout(function() {
                ma()
            }, 750),
            ga -= 5) : 0 <= ga - 10 ? (kb(ga - 10),
            H = window.setTimeout(function() {
                ma()
            }, 40)) : L.style.display = "none")
        }
          , B = a.Console
          , X = System;
        B.maxTotalLines = 1E4;
        ...
        B.consoleOutput = function(a, b) {
            ...
            var e = !1;
            a = ("undefined" == typeof a ? "" : null == a ? "null" : "" + a).replace(/\t/g, ca);
            if (0 < a.length)
                switch (a.charAt(a.length - 1)) {
                case "\n":
                case "\r":
                    a = 1 < a.length ? a.substring(0, a.length - ("\r" == a.charAt(a.length - 2) ? 2 : 1)) : "",
                    e = !0
                }
            var h = null;
            a = a.replace(/\t/g, ca);
            ...
            !B.pinning && (d && -1 != d.indexOf("composite")) && (c.parentNode.scrollTop = c.parentNode.scrollHeight);
